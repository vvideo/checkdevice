...
export const keyset: I18nKeyset = {
    ...
    'Gyroscope is not supported.': {
        'en': 'Gyroscope is not supported.',
        'ru': 'Гироскоп не поддерживается.'
    },
    'Acceleration along the X-axis': {
        'en': 'Acceleration along the X-axis',
        'ru': 'Ускорение вдоль оси X'
    },
    'Acceleration along the Y-axis': {
        'en': 'Acceleration along the Y-axis',
        'ru': 'Ускорение вдоль оси Y'
    },
    'Acceleration along the Z-axis': {
        'en': 'Acceleration along the Z-axis',
        'ru': 'Ускорение вдоль оси Z'
    },
    'Activated': {
        'en': 'Activated',
        'ru': 'Активирован'
    ...
    'Angular velocity along the X-axis': {
        'en': 'Angular velocity along the X-axis',
        'ru': 'Угловая скорость вдоль оси X'
    },
    'Angular velocity along the Y-axis': {
        'en': 'Angular velocity along the Y-axis',
        'ru': 'Угловая скорость вдоль оси Y'
    },
    'Angular velocity along the Z-axis': {
        'en': 'Angular velocity along the Z-axis',
        'ru': 'Угловая скорость вдоль оси Z'
    },
    'Current light level': {
        'en': 'Current light level',
        'ru': 'Текущий уровень освещенности'
    },
    'Acceleration': {
        'en': 'Acceleration',
        'ru': 'Ускорение'
    ...
    'Magnetic field along the X-axis': {
        'en': 'Magnetic field along the X-axis',
        'ru': 'Магнитное поле вдоль оси X'
    },
    'Magnetic field along the Y-axis': {
        'en': 'Magnetic field along the Y-axis',
        'ru': 'Магнитное поле вдоль оси Y'
    },
    'Magnetic field along the Z-axis': {
        'en': 'Magnetic field along the Z-axis',
        'ru': 'Магнитное поле вдоль оси Z'
    },
    'Gravity along the X-axis': {
        'en': 'Gravity along the X-axis',
        'ru': 'Гравитация вдоль оси X'
    },
    'Gravity along the Y-axis': {
        'en': 'Gravity along the Y-axis',
        'ru': 'Гравитация вдоль оси Y'
    },
    'Gravity along the Z-axis': {
        'en': 'Gravity along the Z-axis',
        'ru': 'Гравитация вдоль оси Z'
    },
    'alpha': {
        'en': 'alpha',
        'ru': 'альфа'
