(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function WarningMessage(props) {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<span class=\"", "\">\u26A0\uFE0F ", "</span>"], ["<span class=\"", "\">\u26A0\uFE0F ", "</span>"])), b$c({ theme: props.theme }), props.children);
    }
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<span class=\"", "\">'", "'</span>"], ["<span class=\"", "\">'", "'</span>"])), b$a('string'), data);
        }
        if (typeof data === 'number') {
            return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$a('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$a('function'));
        }
        if (typeof data === 'symbol') {
            return m$1(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('symbol'), data);
        }
    ...
    var templateObject_1$f, templateObject_2$4, templateObject_3$1, templateObject_4$1, templateObject_5$1, templateObject_6$1, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16, templateObject_17;
    ...
    function GamepadList() {
        ...
        return gamepads.length ? m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$7(), gamepads.map(function (rawItem, i) {
            var item = rawItem;
            var data = {
                index: item.index,
            ...
            return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n                        <div class=\"", "\">\n                            <div class=\"", "\">", "</div>\n                            <", " name=\"", "\" data=\"", "\" options=\"", "\"><//>\n                        </div>"], ["\n                        <div class=\"", "\">\n                            <div class=\"", "\">", "</div>\n                            <", " name=\"", "\" data=\"", "\" options=\"", "\"><//>\n                        </div>"])), b$7('item'), b$7('title'), item.id, TreeList, i, data, options);
        })) : m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), GamepadWait);
    }
    function GamepadWait() {
        return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<", " size=\"m\" //> ", " <", " //>"], ["<", " size=\"m\" //> ", " <", " //>"])), Spinner, i18n('Connect and press any button on the gamepad.'), XboxButtons);
    }
