(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$9 = block('row');
    function Row(props) {
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$9(), b$9('category'), props.name, b$9('body'), props.children);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, className, filteredItems.map(function (item) {
            ...
            return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    ...
    function Link(props) {
        ...
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"], ["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"])), props.target, className, props.href, props.children);
    }
    ...
    function StorageFeatures() {
        ...
        var features = [
            [
                m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<", " theme=\"white\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/StorageManager/persist\">", "<//>"], ["<", " theme=\"white\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/StorageManager/persist\">", "<//>"])), ExtLink, i18n('Support of persistent storage')),
                getChecked(Boolean(typeof ((_b = navigator.storage) === null || _b === void 0 ? void 0 : _b.persist) === 'function'))
            ],
        ];
        if (typeof quota === 'number') {
            features.push([
                m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<", " theme=\"white\" href=\"https://developer.mozilla.org/ru/docs/Web/API/StorageManager/estimate\">", "<//>"], ["<", " theme=\"white\" href=\"https://developer.mozilla.org/ru/docs/Web/API/StorageManager/estimate\">", "<//>"])), ExtLink, i18n('Storage quota for origin')),
                formatBytesToGB(quota)
            ]);
        }
        return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", " title=\"", "\" items=\"", "\"><//>"], ["<", " title=\"", "\" items=\"", "\"><//>"])), List, i18n('Features'), features);
    }
    ...
    var b$6 = block('storages');
    function Storages() {
        var _a;
        var hasOPFS = !isSsr && typeof ((_a = navigator.storage) === null || _a === void 0 ? void 0 : _a.getDirectory) === 'function';
        var items = [
            [
                m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<", " theme=\"white\" href=\"", "\">Cookies<//>"], ["<", " theme=\"white\" href=\"", "\">Cookies<//>"])), ExtLink, mdnLinks.cookies),
                isSsr ? '…' : getChecked(navigator.cookieEnabled)
            ],
            [
                m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<", " theme=\"white\" href=\"", "\">Local storage<//>"], ["<", " theme=\"white\" href=\"", "\">Local storage<//>"])), ExtLink, mdnLinks.localStorage),
                isSsr ? '…' : getChecked(Boolean(window.localStorage))
            ],
            [
                m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " theme=\"white\" href=\"", "\">Session storage<//>"], ["<", " theme=\"white\" href=\"", "\">Session storage<//>"])), ExtLink, mdnLinks.sessionStorage),
                isSsr ? '…' : getChecked(Boolean(window.sessionStorage))
            ],
            [
                m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<", " theme=\"white\" href=\"", "\">IndexedDB<//>"], ["<", " theme=\"white\" href=\"", "\">IndexedDB<//>"])), ExtLink, mdnLinks.indexeddb),
                isSsr ? '…' : getChecked(Boolean(window.indexedDB))
            ],
            [
                m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<", " theme=\"white\" href=\"", "\">Origin private file system<//>"], ["<", " theme=\"white\" href=\"", "\">Origin private file system<//>"])), ExtLink, mdnLinks.opfs),
                isSsr ? '…' : getChecked(hasOPFS)
            ],
        ];
        return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <", " items=\"", "\" />\n\n            <div class=\"", "\">\n                <", "><//>\n            </div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <", " items=\"", "\" />\n\n            <div class=\"", "\">\n                <", "><//>\n            </div>\n        </div>\n    "])), b$6(), List, items, b$6('features'), StorageFeatures);
    }
    var templateObject_1$a, templateObject_2$3, templateObject_3, templateObject_4, templateObject_5, templateObject_6;
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), StoragePage), document.querySelector('.page'));
