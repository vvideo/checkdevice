(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$c = block('section');
    function Section(props) {
        if (!props.children) {
            return null;
        }
        var className = classname(b$c(), props.class);
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$c('name') }, props.name),
            _("div", { class: b$c('body') }, props.children))) : (_("div", { class: b$c() }, props.children));
    }
    ...
    function StorageFeatures() {
        ...
        var features = [
            [
                (_(ExtLink, { theme: "page-theme", href: "https://developer.mozilla.org/en-US/docs/Web/API/StorageManager/persist" }, i18n('Support of persistent storage'))),
                getChecked(Boolean(typeof ((_b = navigator.storage) === null || _b === void 0 ? void 0 : _b.persist) === 'function'))
            ],
        ];
        if (typeof quota === 'number') {
            features.push([
                (_(ExtLink, { theme: "page-theme", href: "https://developer.mozilla.org/ru/docs/Web/API/StorageManager/estimate" }, i18n('Storage quota for origin'))),
                formatBytesToGB(quota)
            ]);
        }
        return (_(List, { title: i18n('Features'), items: features }));
    }
    ...
    var b$9 = block('storage');
    function Storage() {
        var _a;
        var hasOPFS = !isSsr && typeof ((_a = navigator.storage) === null || _a === void 0 ? void 0 : _a.getDirectory) === 'function';
        var items = [
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.cookies }, "Cookies")),
                isSsr ? (_(ValueInProgress, null)) : getChecked(navigator.cookieEnabled)
            ],
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.localStorage }, "Local storage")),
                isSsr ? (_(ValueInProgress, null)) : getChecked(Boolean(window.localStorage))
            ],
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.sessionStorage }, "Session storage")),
                isSsr ? (_(ValueInProgress, null)) : getChecked(Boolean(window.sessionStorage))
            ],
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.sharedStorage }, "Shared storage")),
                isSsr ?
            ...
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.indexeddb }, "IndexedDB")),
                isSsr ? (_(ValueInProgress, null)) : getChecked(Boolean(window.indexedDB))
            ],
            [
                (_(ExtLink, { theme: "page-theme", href: mdnLinks.opfs }, "Origin private file system")),
                isSsr ? (_(ValueInProgress, null)) : getChecked(hasOPFS)
            ],
        ];
        return (_("div", { class: b$9() },
            _(List, { items: items }),
            _("div", { class: b$9('features') },
                _(StorageFeatures, null))));
    }
    ...
    function StoragePage() {
        return (_(Page, { title: i18n('Storage') },
            _(Storage, null)));
    }
