(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function IndexMenu() {
        ...
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<nav class=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n        <div class=\"", "\"></div>\n    </nav>\n    "], ["<nav class=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n        <div class=\"", "\"></div>\n    </nav>\n    "])), b(), b('list'), items.map(function (item) {
            return m$1(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["<li key=\"", "\" class=\"", "\"><", " class=\"", "\" theme=\"white\" href=\"", "\"><span class=\"", "\">", "</span> ", "<//></li>"], ["<li key=\"", "\" class=\"", "\"><", " class=\"", "\" theme=\"white\" href=\"", "\"><span class=\"", "\">", "</span> ", "<//></li>"])), item.id, b('item'), Link, b('link'), getPagePath(item.id), b('emoji'), item.emoji, item.title);
        }), b('clear'));
    }
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), IndexPage), document.querySelector('.page'));
