(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b = block('index-menu');
    function IndexMenu() {
        var lang = getI18nLang();
        var items = pages.filter(function (item) { return !item.hidden; }).map(function (item) {
            return __assign(__assign({}, item), { title: i18nWithKeyset(item.menuTitle), indexMenuList: item.indexMenuList ? item.indexMenuList[lang] : [] });
        });
        return (_("nav", { class: b() },
            _("ul", { class: b('list') }, items.map(function (item) {
                return (_("li", { key: item.id, class: b('item') },
                    _(Link, { class: b('link'), theme: "page-theme", href: getPagePath(item.id) },
                        _("span", null,
                            _("span", { class: b('image', { type: item.id }) }),
                            " ",
                            item.title)),
                    _("ul", { class: b('keywords-list') }, item.indexMenuList.map(function (text) { return (_("li", { class: b('keywords-item') },
                        _("div", { class: b('keywords-item-container') }, text))); }))));
            })),
            _("div", { class: b('clear') })));
    }
    ...
    function IndexPage() {
        return (_(Page, { withoutMenu: true },
            _(IndexMenu, null)));
    }
