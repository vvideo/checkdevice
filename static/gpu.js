(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function RadioButtons(props) {
        ...
        return m$1(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n        <fieldset class=\"", "\">\n            ", "\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </fieldset>\n    "], ["\n        <fieldset class=\"", "\">\n            ", "\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </fieldset>\n    "])), classname(b$d(), className), props.hideLabel || !label ? m$1(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["<legend class=\"", "\">", "</legend>"], ["<legend class=\"", "\">", "</legend>"])), b$d('label'), label) : '', b$d('items'), buttons.map(function (item) {
            return m$1(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"], ["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"])), RadioButton, item.value, b$d('item'), item.value === selectedValue, item.text, item.value, handleSelect);
        }));
    }
    var templateObject_1$j, templateObject_2$6, templateObject_3$3;
    ...
    var b$c = block('warning-message');
    function WarningMessage(props) {
        return m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<span class=\"", "\">\u26A0\uFE0F ", "</span>"], ["<span class=\"", "\">\u26A0\uFE0F ", "</span>"])), b$c({ theme: props.theme }), props.children);
    }
    var templateObject_1$i;

    var b$b = block('row');
    function Row(props) {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$b(), b$b('category'), props.name, b$b('body'), props.children);
    }
    var templateObject_1$h;

    var b$a = block('tree-list');
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<span class=\"", "\">'", "'</span>"], ["<span class=\"", "\">'", "'</span>"])), b$a('string'), data);
        }
        if (typeof data === 'number') {
            return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$a('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$a('function'));
        }
        if (typeof data === 'symbol') {
            return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$a('symbol'), data);
        }
        if (typeof data === 'undefined') {
            return m$1(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<span class=\"", "\">undefined</span>"], ["<span class=\"", "\">undefined</span>"])), b$a('undefined'));
        }
        if (data === null) {
            return m$1(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<span class=\"", "\">null</span>"], ["<span class=\"", "\">null</span>"])), b$a('null'));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                ...
                return m$1(templateObject_13 || (templateObject_13 = __makeTemplateObject(["[<ul>\n                ", "\n            </ul>]"], ["[<ul>\n                ", "\n            </ul>]"])), data.map(function (item, i) {
                    var arrayIndex = options.showArrayIndex ? m$1(templateObject_11 || (templateObject_11 = __makeTemplateObject([" <span class=\"", "\">", ": </span>"], [" <span class=\"", "\">", ": </span>"])), b$a('index'), i) : '';
        ...
        if (options.compactObject && level > 0) {
            return m$1(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{", "\n            ", "\n        ", "}"], ["{", "\n            ", "\n        ", "}"])), ' ', Object.keys(data).map(function (key, i, items) {
                return m$1(templateObject_14 || (templateObject_14 = __makeTemplateObject(["<span class=\"", "\">", ": </span>", "", ""], ["<span class=\"", "\">", ": </span>", "", ""])), b$a('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ', ');
            }), ' ');
        }
        var hasBraces = Boolean(options.showCurlyBracesAtRootLevel || level);
        return m$1(templateObject_17 || (templateObject_17 = __makeTemplateObject(["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""], ["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""])), hasBraces ? '{' : '', b$a('ul', { padding: hasBraces ? 'yes' : 'no' }), Object.keys(data).map(function (key, i, items) {
            return m$1(templateObject_16 || (templateObject_16 = __makeTemplateObject(["<li><span class=\"", "\">", ": </span>", "", "</li>"], ["<li><span class=\"", "\">", ": </span>", "", "</li>"])), b$a('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ',');
        }), hasBraces ? '}' : '');
    }
    var templateObject_1$g, templateObject_2$5, templateObject_3$2, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16, templateObject_17;

    function TreeList(props) {
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"], ["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"])), Row, props.title, b$a(), buildData(props.data, props.options));
    }
    ...
    function GpuNavigator() {
        ...
        if (typeof navigator === 'undefined' || !navigator.gpu) {
            return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('WebGPU is not supported.'));
        }
        if (hasAdapter === null) {
            return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('GPU Adapter is not found.'));
        }
        return hasAdapter ? m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                <", "\n                    label=\"Power preference:\"\n                    buttons=\"", "\"\n                    onSelect=\"", "\"\n                ><//>\n            </div>\n\n            <", " title=\"Adapter\" data=", "><//>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                <", "\n                    label=\"Power preference:\"\n                    buttons=\"", "\"\n                    onSelect=\"", "\"\n                ><//>\n            </div>\n\n            <", " title=\"Adapter\" data=", "><//>\n        </div>\n    "])), b$9(), b$9('controls'), RadioButtons, buttons, onSelect, TreeList, data) : '...';
    }
    var templateObject_1$e, templateObject_2$4, templateObject_3$1;
    ...
    function List(props) {
        ...
        var className = classname(props.class, b$8());
        return filteredItems.length ? m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, className, filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
            return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    ...
    function WebGLContext() {
        ...
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<", " title=\"WebGL context\" items=\"", "\" //>"], ["<", " title=\"WebGL context\" items=\"", "\" //>"])), List, items);
    }
    ...
    var b$7 = block('link');
    function Link(props) {
        var className = classname(props.class, b$7({ theme: props.theme }));
        return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"], ["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"])), props.target, className, props.href, props.children);
    }
    var templateObject_1$b;

    var b$6 = block('lang-switcher-item');
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$6(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function LangSwitcher() {
        ...
        return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"])), b$5(), b$5('current'), handleClick, b$5('emoji'), currentLangItem.emoji, currentLangItem.name, b$5('popup', { visible: visible }), langs.map(function (item) { return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"], ["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"])), LangSwitcherItem, currentLang === item.value, item.value, handleClickItem, item); }));
    }
    var templateObject_1$9, templateObject_2$2;

    var b$4 = block('footer');
    function Footer() {
        return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"], ["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"])), b$4(), b$4('item', { report: true }), Link, i18n('Report a bug'), b$4('item'), LangSwitcher, b$4('item'));
    }
    var templateObject_1$8;

    var b$3 = block('main-menu');
    function MainMenu(props) {
        return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "], ["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "])), b$3(), b$3('list'), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"], ["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"])), b$3('item', { selected: item.selected }), item.id, b$3('link'), getPagePath(item.id), item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    var templateObject_1$6;

    var b$2 = block('header');
    function Header() {
        return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n        <header class=\"", "\">\n            <", " theme=\"white\" href=\"", "\"><span class=\"", "\"></span>", "<//>\n        </header>\n    "], ["\n        <header class=\"", "\">\n            <", " theme=\"white\" href=\"", "\"><span class=\"", "\"></span>", "<//>\n        </header>\n    "])), b$2(), Link, getPagePath('index'), b$2('logo'), i18n('Check device online'));
    }
    var templateObject_1$5;

    function Page(props) {
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"], ["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"])), Header, props.withoutMenu ? '' : m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<", "><//>"], ["<", "><//>"])), Menu), props.children, Footer);
    }
    var templateObject_1$4, templateObject_2;

    var b$1 = block('cube-3d');
    function Cube3d() {
        return m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n    <div class=\"", "\">\n        <div class=\"", "\">\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    </div>"], ["\n    <div class=\"", "\">\n        <div class=\"", "\">\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    </div>"])), b$1(), b$1('container'), b$1('side', { back: true }), b$1('side', { left: true }), b$1('side', { right: true }), b$1('side', { top: true }), b$1('side', { bottom: true }), b$1('side', { front: true }));
    }
