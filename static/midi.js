(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$3 = block('error-message');
    function ErrorMessage(props) {
        var className = classname(props.class, b$3({ theme: props.theme }));
        return (_("div", { class: className },
            "\u274C ",
            props.children));
    }

    function MidiError(props) {
        if (!props.error) {
            return null;
        }
    ...
    function Spinner(props) {
        return (_("div", { class: b$2({ size: props.size }) }));
    }
    ...
    function Midi() {
        ...
        if (!isSsr && typeof navigator.requestMIDIAccess !== 'function') {
            return (_(WarningMessage, null, i18n('Web MIDI API is not supported.')));
        }
        return (_("div", { class: b() },
            _(Button, { disabled: disabled, theme: "active", onClick: handleClick },
                _("span", null,
                    ...
                    " ",
                    i18n('Request'))),
            _(MidiError, { error: error })));
    }

    addI18nKeyset(keyset);
    function MidiPage() {
        return (_(Page, { title: i18n('MIDI') },
            _(Midi, null)));
    }
