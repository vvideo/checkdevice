(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$b = block('lang-icon');
    function LangIcon(props) {
        return (_("span", { class: b$b({ lang: props.lang }) }));
    }
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$9() },
            _("div", { class: b$9('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$9('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    function Footer() {
        return (_("footer", { class: b$8() },
            _("div", { class: b$8('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$8('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$8('item') }, "\u00A9 Vvideo")));
    }

    var b$7 = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$7() },
            _("ul", { class: b$7('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$7('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$7('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$6({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$5 = block('header');
    function Header() {
        return (_("header", { class: b$5() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$5('logo') }),
                    i18n('Check device online'))),
            _(ThemeSwitcher, null)));
    }

    var b$4 = block('page-title');
    function PageTitle(props) {
        return (_("h1", { class: b$4() }, props.children));
    }

    var b$3 = block('page');
    function Page(props) {
        return (_("div", { class: b$3() },
            _(Header, null),
    ...
    var b$2 = block('section');
    function Section(props) {
        if (!props.children) {
            return null;
        }
        var className = classname(b$2(), props.class);
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$2('name') }, props.name),
            _("div", { class: b$2('body') }, props.children))) : (_("div", { class: b$2() }, props.children));
    }
    ...
    function Sensor() {
        ...
        var _k = h(null), motionEvent = _k[0], setMotionEvent = _k[1];
        y(function () {
        ...
        var accelerationItems = (motionEvent === null || motionEvent === void 0 ? void 0 : motionEvent.acceleration) ? [
            ['x: ', (_a = motionEvent.acceleration) === null || _a === void 0 ? void 0 : _a.x],
            ['y: ', (_b = motionEvent.acceleration) === null || _b === void 0 ? void 0 : _b.y],
            ['z: ', (_c = motionEvent.acceleration) === null || _c === void 0 ? void 0 : _c.z],
        ] : [];
        var accelerationIncludingGravityItems = (motionEvent === null || motionEvent === void 0 ? void 0 : motionEvent.acceleration) ? [
            ['x: ', (_d = motionEvent.accelerationIncludingGravity) === null || _d === void 0 ? void 0 : _d.x],
            ['y: ', (_e = motionEvent.accelerationIncludingGravity) === null || _e === void 0 ? void 0 : _e.y],
            ['z: ', (_f = motionEvent.accelerationIncludingGravity) === null || _f === void 0 ? void 0 : _f.z],
        ] : [];
        var rotationRateItems = (motionEvent === null || motionEvent === void 0 ? void 0 : motionEvent.rotationRate) ? [
            ['alpha: ', (_g = motionEvent.rotationRate) === null || _g === void 0 ? void 0 : _g.alpha],
            ['beta: ', (_h = motionEvent.rotationRate) === null || _h === void 0 ? void 0 : _h.beta],
            ['gamma: ', (_j = motionEvent.rotationRate) === null || _j === void 0 ? void 0 : _j.gamma],
        ] : [];
        return (_("div", { class: b() },
            accelerationItems.length ? (_(List, { title: i18n('Acceleration'), items: accelerationItems })) : null,
            accelerationIncludingGravityItems.length ? (_(List, { title: i18n('Acceleration including gravity'), items: accelerationItems })) : null,
            rotationRateItems.length ? (_(List, { title: i18n('Rotation rate'), items: rotationRateItems })) : null));
    }
    ...
    function SensorPage() {
        return (_(Page, { title: i18n('Sensors') },
            _(Sensor, null)));
    }
