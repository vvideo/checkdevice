(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function Link(props) {
        ...
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"], ["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"])), props.target, className, props.href, props.children);
    }
    ...
    var b$9 = block('lang-switcher-item');
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$9(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function LangSwitcher() {
        ...
        return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"])), b$8(), b$8('current'), handleClick, b$8('emoji'), currentLangItem.emoji, currentLangItem.name, b$8('popup', { visible: visible }), langs.map(function (item) { return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"], ["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"])), LangSwitcherItem, currentLang === item.value, item.value, handleClickItem, item); }));
    }
    var templateObject_1$e, templateObject_2$5;

    var b$7 = block('footer');
    function Footer() {
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"], ["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"])), b$7(), b$7('item', { report: true }), Link, i18n('Report a bug'), b$7('item'), LangSwitcher, b$7('item'));
    }
    var templateObject_1$d;

    var b$6 = block('main-menu');
    function MainMenu(props) {
        return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "], ["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "])), b$6(), b$6('list'), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"], ["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"])), b$6('item', { selected: item.selected }), item.id, b$6('link'), getPagePath(item.id), item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    var templateObject_1$b;

    var b$5 = block('header');
    function Header() {
        return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n        <header class=\"", "\">\n            <", " theme=\"white\" href=\"", "\"><span class=\"", "\"></span>", "<//>\n        </header>\n    "], ["\n        <header class=\"", "\">\n            <", " theme=\"white\" href=\"", "\"><span class=\"", "\"></span>", "<//>\n        </header>\n    "])), b$5(), Link, getPagePath('index'), b$5('logo'), i18n('Check device online'));
    }
    var templateObject_1$a;

    function Page(props) {
        return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"], ["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"])), Header, props.withoutMenu ? '' : m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<", "><//>"], ["<", "><//>"])), Menu), props.children, Footer);
    }
    var templateObject_1$9, templateObject_2$3;

    var b$4 = block('row');
    function Row(props) {
        return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$4(), b$4('category'), props.name, b$4('body'), props.children);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, className, filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
            return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    ...
    function InfoLink(props) {
        return m$1(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["<span class=\"", "\">\n        <a class=\"", "\" href=\"", "\" title=\"", "\" target=\"_blank\">\u24D8</a>\n    </span>"], ["<span class=\"", "\">\n        <a class=\"", "\" href=\"", "\" title=\"", "\" target=\"_blank\">\u24D8</a>\n    </span>"])), b$2(), b$2('link'), props.href, props.title);
    }
    ...
    function Platform() {
        ...
        var items = [
            [
                m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["Hardware concurrency <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/hardwareConcurrency\"><//>"], ["Hardware concurrency <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/hardwareConcurrency\"><//>"])), InfoLink),
        ...
        if (!isSsr && navigator.deviceMemory) {
            items.unshift([
                m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["", " <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/deviceMemory\"><//>"], ["", " <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/deviceMemory\"><//>"])), i18n('RAM'), InfoLink),
    ...
    function Spinner(props) {
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$1({ size: props.size }));
    }
    ...
    function Permissions() {
        ...
        var items = result
            .map(function (item) {
            var color = getStatusColor(item.state);
            return [item.name, m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["<span style=\"color: ", "\">", "</span>"], ["<span style=\"color: ", "\">", "</span>"])), color, item.state)];
        })
        ...
        return done ? m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<", " title=\"", "\" items=\"", "\" //>"], ["<", " title=\"", "\" items=\"", "\" //>"])), List, i18n('Permissions'), items) : m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), Spinner);
    }
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), PlatformPage), document.querySelector('.page'));
