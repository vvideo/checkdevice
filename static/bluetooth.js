(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$d() },
            _("div", { class: b$d('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$d('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    function Footer() {
        return (_("footer", { class: b$c() },
            _("div", { class: b$c('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$c('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$c('item') }, "\u00A9 Vvideo")));
    }

    var b$b = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$b() },
            _("ul", { class: b$b('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$b('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$b('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$a({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$9 = block('header');
    function Header() {
        return (_("header", { class: b$9() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$9('logo') }),
                    i18n('Check device online'))),
            _(ThemeSwitcher, null)));
    }

    var b$8 = block('page-title');
    function PageTitle(props) {
        return (_("h1", { class: b$8() }, props.children));
    }

    var b$7 = block('page');
    function Page(props) {
        return (_("div", { class: b$7() },
            _(Header, null),
    ...
    function BluetoothError(props) {
        if (!props.error) {
            return null;
        }
        return (_(ErrorMessage, null, String(props.error)));
    }

    var b$4 = block('spinner');
    function Spinner(props) {
        return (_("div", { class: b$4({ size: props.size }) }));
    }

    var b$3 = block('warning-message');
    function WarningMessage(props) {
        return (_("span", { class: b$3({ theme: props.theme }) },
            "\u26A0\uFE0F ",
            props.children));
    }
    ...
    var b = block('bluetooth');
    function Bluetooth() {
        var _a = h(null), error = _a[0], setError = _a[1];
        var _b = h(false), disabled = _b[0], setDisabled = _b[1];
        var _c = h(null), device = _c[0], setDevice = _c[1];
        var handleClick = q(function () {
            setDisabled(true);
            // @ts-ignore
            navigator.bluetooth.requestDevice({ acceptAllDevices: true }).then(function (bluetoothDevice) {
                setDisabled(false);
                setError(null);
        ...
        if (!isSsr && !navigator.bluetooth) {
            return (_(WarningMessage, null, i18n('Web Bluetooth API is not supported.')));
        }
        var items = [];
        if (device) {
            items.push([
        ...
        return (_("div", { class: b() },
            _(Button, { disabled: disabled, theme: "active", onClick: handleClick },
                _("span", null,
                    disabled ? (_(Spinner, { size: "s" })) : null,
                    " ",
                    i18n('Request'))),
            _(List, { class: b('list'), items: items }),
            _(BluetoothError, { error: error })));
    }

    addI18nKeyset(keyset);
    function BluetoothPage() {
        return (_(Page, { title: i18n('Bluetooth') },
            _(Bluetooth, null)));
    }
