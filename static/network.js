    ...
    ***************************************************************************** */
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'number') {
            return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$b('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$b('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$b('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$b('function'));
        }
    ...
    var templateObject_1$h, templateObject_2$5, templateObject_3$2, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16, templateObject_17;
    ...
    function List(props) {
        ...
        var className = classname(props.class, b$9());
    ...
    function IP() {
        ...
        var items = [
            ...
            ['IPv6', ipv6 || m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<", " size=\"s\" //>"], ["<", " size=\"s\" //>"])), Spinner)]
        ];
        return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " items=\"", "\" //>"], ["<", " items=\"", "\" //>"])), List, items);
    }
    var templateObject_1$c, templateObject_2$3, templateObject_3;
