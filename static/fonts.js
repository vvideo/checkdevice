(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$g = block('button');
    function Button(props) {
        var disabled = props.disabled, size = props.size, theme = props.theme, onClick = props.onClick;
        var className = classname(props.class, b$g({ theme: theme, size: size, disabled: disabled }));
    ...
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$f({ checked: checked, theme: props.theme }));
        return m$1(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"], ["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"])), className, handleClick, ref, b$f('input'), checked, props.label);
    }
    ...
    function Input(props) {
        ...
        return m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<input ref=\"", "\" class=\"", "\" onInput=\"", "\" placeholder=\"", "\" value=\"", "\" />"], ["<input ref=\"", "\" class=\"", "\" onInput=\"", "\" placeholder=\"", "\" value=\"", "\" />"])), ref, className, handleInput, props.placeholder, value);
    }
    var templateObject_1$i;

    var b$d = block('warning-message');
    function WarningMessage(props) {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<span class=\"", "\">\u26A0\uFE0F ", "</span>"], ["<span class=\"", "\">\u26A0\uFE0F ", "</span>"])), b$d({ theme: props.theme }), props.children);
    }
    ...
    var b$c = block('font-item');
    function FontItem(props) {
        var _a = h(false), opened = _a[0], setOpened = _a[1];
        var handleClick = q(function () {
            setOpened(!opened);
        }, [opened]);
        return m$1(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\n            <span class=\"", "\" onClick=\"", "\">", "</span>\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\n            <span class=\"", "\" onClick=\"", "\">", "</span>\n            ", "\n        </div>\n    </div>"])), b$c({ opened: opened }), b$c('value'), b$c('switcher'), handleClick, props.fullName, opened ? m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<div class=\"", "\">\n                <div class=\"", "\">", ": ", "</div>\n                <div class=\"", "\">", ": ", "</div>\n            </div>"], ["<div class=\"", "\">\n                <div class=\"", "\">", ": ", "</div>\n                <div class=\"", "\">", ": ", "</div>\n            </div>"])), b$c('content'), b$c('family'), i18n('Family'), props.family, b$c('style'), i18n('Style'), props.style) : '');
    }
    var templateObject_1$g, templateObject_2$7;

    var b$b = block('font-list');
    function FontList(props) {
        var items = props.items;
        return m$1(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["<div class=\"", "\">\n        ", "\n    </div>"], ["<div class=\"", "\">\n        ", "\n    </div>"])), b$b(), items.map(function (item, i) {
            return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<", " key=\"", "\" family=\"", "\" fullName=\"", "\" style=\"", "\" num=\"", "\" //>"], ["<", " key=\"", "\" family=\"", "\" fullName=\"", "\" style=\"", "\" num=\"", "\" //>"])), FontItem, item.fullName, item.family, item.fullName, item.style, i + 1);
        }));
    }
    var templateObject_1$f, templateObject_2$6;

    var b$a = block('font-family-item');
    function FontFamilyItem(props) {
        var _a = h(false), opened = _a[0], setOpened = _a[1];
        var handleClick = q(function () {
            setOpened(!opened);
        }, [opened]);
        return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\n            <span class=\"", "\" onClick=\"", "\">", "</span>\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\n            <span class=\"", "\" onClick=\"", "\">", "</span>\n            ", "\n        </div>\n    </div>"])), b$a({ opened: opened }), b$a('value'), b$a('switcher'), handleClick, props.name, opened ? m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<div class=\"", "\"><", " items=\"", "\" //></div>"], ["<div class=\"", "\"><", " items=\"", "\" //></div>"])), b$a('items'), FontList, props.items) : '');
    }
    var templateObject_1$e, templateObject_2$5;

    var b$9 = block('font-list-grouped');
    function FontListGrouped(props) {
        var items = props.items;
        var groupedItems = groupByFamily(items);
        return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<div class=\"", "\">\n        ", "\n    </div>"], ["<div class=\"", "\">\n        ", "\n    </div>"])), b$9(), groupedItems.map(function (item, i) {
            return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<", " key=\"", "\" name=\"", "\" items=\"", "\" num=\"", "\" //>"], ["<", " key=\"", "\" name=\"", "\" items=\"", "\" num=\"", "\" //>"])), FontFamilyItem, item.name, item.name, item.items, i + 1);
        }));
    }
    ...
    function Spinner(props) {
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$8({ size: props.size }));
    }
    ...
    function Fonts() {
        if (isSsr) {
            return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<", " //>"], ["<", " //>"])), Spinner);
        }
        if (!window.queryLocalFonts) {
            return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Local Font Access API is not supported.'));
        }
        ...
        return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                ", "\n                ", "\n                ", "\n            </div>\n            <", " items=\"", "\" />\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                ", "\n                ", "\n                ", "\n            </div>\n            <", " items=\"", "\" />\n        </div>\n    "])), b$7(), b$7('controls'), fonts ? '' : m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " theme=\"active\" onClick=\"", "\">", "<//>"], ["<", " theme=\"active\" onClick=\"", "\">", "<//>"])), Button, handleButtonClick, i18n('Request fonts')), fonts ? m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<", " class=\"", "\" placeholder=\"", "\" value=\"\" onChange=\"", "\" //>"], ["<", " class=\"", "\" placeholder=\"", "\" value=\"\" onChange=\"", "\" //>"])), Input, b$7('filter'), i18n('Filter'), handleChange) : '', fonts ? m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<div class=\"", "\"><", " onClick=\"", "\" label=\"", "\" checked=\"", "\" //></div>"], ["<div class=\"", "\"><", " onClick=\"", "\" label=\"", "\" checked=\"", "\" //></div>"])), b$7('group-by-family'), Checkbox, handleCheckboxClick, i18n('Group by family'), groupByFamily) : '', groupByFamily ? FontListGrouped : FontList, items);
    }
    var templateObject_1$b, templateObject_2$3, templateObject_3, templateObject_4, templateObject_5, templateObject_6;
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), FontsPage), document.querySelector('.page'));
