(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$e = block('battery-badge');
    function BatteryBadge(props) {
        return (_("div", { class: b$e({ low: props.level < 0.2 }) },
            _("div", { class: b$e('charge'), style: "width: ".concat(props.level * 100, "%") }),
            _("div", { class: b$e('contact') }),
            props.charging ? (_("div", { class: b$e('charging') }, "\u21AF")) : '',
            _("div", { class: b$e('level') },
    ...
    var b$a = block('battery-status');
    function BatteryStatus() {
        if (isSsr) {
            return (_(BatteryStatusSsr, null));
        }
        if (!navigator.getBattery) {
            return (_(WarningMessage, null, i18n('Battery Status API is not supported.')));
        }
        ...
        return batteryManager ? (_("div", { class: b$a() },
            _(BatteryBadge, { level: batteryManager.level, charging: batteryManager.charging }),
            _(List, { class: b$a('list'), items: items }))) : (_(Spinner, null));
    }
    function BatteryStatusSsr() {
        var items = [
            [i18n('Charging time'), (_(ValueInProgress, null))],
            [i18n('Discharging time'), (_(ValueInProgress, null))]
        ];
        return (_("div", { class: b$a() },
            _(BatteryBadge, { level: 0, charging: false }),
            _(List, { class: b$a('list'), items: items })));
    }
    ...
    function BatteryPage() {
        return (_(Page, { title: i18n('Battery') },
            _(BatteryStatus, null)));
    }
