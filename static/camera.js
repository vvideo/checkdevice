(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function savePhoto(video, fileName) {
    ...
    function RadioButtons(props) {
        ...
        return (_("fieldset", { class: classname(b$h(), className) },
            label ? (_("legend", { class: b$h('label', { hidden: props.hideLabel }) }, label)) : '',
            _("ul", { class: b$h('items') }, buttons.map(function (item) {
                return (_(RadioButton, { key: item.value, class: b$h('item'), selected: item.value === selectedValue, title: item.title, text: item.text, value: item.value, onClick: handleSelect }));
            }))));
    }

    var b$g = block('warning-message');
    function WarningMessage(props) {
        return (_("span", { class: b$g({ theme: props.theme }) },
            "\u26A0\uFE0F ",
            props.children));
    }

    var b$f = block('section');
    function Section(props) {
        if (!props.children) {
            return null;
        }
        var className = classname(b$f(), props.class);
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$f('name') }, props.name),
            _("div", { class: b$f('body') }, props.children))) : (_("div", { class: b$f() }, props.children));
    }
    ...
    function List(props) {
        ...
        var className = classname(props.class, b$e());
    ...
    function MicInfo(props) {
        var audioParams = [
            ...
            [i18n('Latency'), typeof props.latency === 'number' ? "".concat(props.latency, " ").concat(i18n('sec.')) : props.latency],
        ...
        return (_(List, { title: props.label, items: audioParams }));
    }

    var b$d = block('camera-info');
    function CameraInfo(props) {
        var video = props.video, audio = props.audio;
        var videoParams = video ? [
            [i18n('Resolution'), "".concat(video.width, "\u00D7").concat(video.height)],
            [
                i18n('Aspect ratio'),
                video.width && video.height ?
                    calcAspectRatio(Math.max(video.width, video.height), Math.min(video.width, video.height)).value : undefined
            ],
            [i18n('Frame rate'), "".concat(video.frameRate)],
            [i18n('Resize mode'), video.resizeMode],
        ] : [];
        return (_("div", { class: b$d('camera-info') },
            _(List, { title: video === null || video === void 0 ? void 0 : video.label, items: videoParams }),
            audio ? (_(MicInfo, __assign({}, audio))) : ''));
    }

    var b$c = block('checkbox');
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$c({ checked: checked, theme: props.theme, focus: focus }));
        y(function () {
            if (!ref.current) {
                return;
            }
        ...
        return (_("label", { title: props.title, class: className, onClick: handleClick },
            _("input", { type: "checkbox", ref: ref, class: b$c('input'), checked: checked }),
            props.label));
    }

    var b$b = block('error-message');
    function ErrorMessage(props) {
        var className = classname(props.class, b$b({ theme: props.theme }));
    ...
    function CameraError(props) {
        ...
        if (error.name === 'NotFoundError') {
            return (_(ErrorMessage, null, i18n('Camera not found.')));
        }
        if (error.name === 'NotAllowedError') {
            return (_(ErrorMessage, null, i18n('Camera is blocked.')));
        }
        return (_(ErrorMessage, null, error.message));
    }
    ...
    function Camera() {
        ...
        var _d = h(false), withMirror = _d[0], setWithMirror = _d[1];
        var _e = h(null), error = _e[0], setError = _e[1];
        var handleClick = q(function () {
        ...
        var handleSavePhoto = q(function () {
            if (refVideo.current) {
                savePhoto(refVideo.current, "camera_photo_".concat(new Date().toISOString().split('T')[0], ".png"));
            }
        }, []);
        var handleSelect = q(function (value) {
            var video = refVideo.current;
        ...
        var handleMirror = q(function (checked) {
            setWithMirror(checked);
        }, []);
        var params = stream ? getStreamParams(stream) : undefined;
        if (!isSsr) {
            if (!navigator.mediaDevices || typeof navigator.mediaDevices.getUserMedia !== 'function') {
                return (_(WarningMessage, null, i18n('Media Devices API is not supported.')));
            }
        }
        var showStop = Boolean(stream);
        var played = Boolean(stream);
        return (_("div", { class: b$a() },
            _("div", { class: b$a('select') },
                _(Button, { class: b$a('select-camera'), theme: showStop ? 'red' : 'active', onClick: handleClick }, stream ? i18n('Stop') : i18n('Check camera')),
                _(Checkbox, { class: b$a('mic'), title: i18n('On/off microphone'), label: i18n('Mic'), checked: withMic, onClick: handleMic })),
            _("div", { class: b$a('top-controls') },
                _(RadioButtons, { hideLabel: true, label: i18n('Select camera option'), onSelect: handleSelect, buttons: buttons })),
            _(CameraError, { error: error }),
            _("div", { class: b$a('container', { played: played }) },
                _("video", { ref: refVideo, class: b$a('video', { mirror: withMirror }) })),
            showStop ? (_("div", { class: b$a('bottom-controls') },
                _(Button, { onClick: handleSavePhoto }, i18n('Save photo')),
                _(Checkbox, { class: b$a('mirror'), title: i18n('On/off mirror mode'), label: i18n('Mirror'), checked: withMirror, onClick: handleMirror }))) : '',
            _("div", { class: b$a('params') }, params ? (_(CameraInfo, __assign({}, params))) : '')));
    }
    ...
    function CameraPage() {
        return (_(Page, { title: i18n('Webcamera') },
            _(Camera, null)));
    }
