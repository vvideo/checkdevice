(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$d = block('button');
    function Button(props) {
        var disabled = props.disabled, size = props.size, theme = props.theme, onClick = props.onClick;
        var className = classname(props.class, b$d({ theme: theme, size: size, disabled: disabled }));
        ...
        return m$1(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"])), className, disabled, handleClick, props.children);
    }
    var templateObject_1$k;

    var b$c = block('radio-button');
    function RadioButton(props) {
        var handleClick = q(function () {
            var _a;
            (_a = props.onClick) === null || _a === void 0 ? void 0 : _a.call(props, props.value);
        }, [props.onClick]);
        var className = classname(b$c({ selected: props.selected }), props.class);
        return m$1(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n        <li\n            class=\"", "\"\n            onClick=\"", "\"\n            key=\"", "\"\n        >", "</li>\n    "], ["\n        <li\n            class=\"", "\"\n            onClick=\"", "\"\n            key=\"", "\"\n        >", "</li>\n    "])), className, handleClick, props.value, props.text);
    }
    var templateObject_1$j;

    var b$b = block('radio-buttons');
    ...
    function RadioButtons(props) {
        ...
        return m$1(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n        <fieldset class=\"", "\">\n            ", "\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </fieldset>\n    "], ["\n        <fieldset class=\"", "\">\n            ", "\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </fieldset>\n    "])), classname(b$b(), className), props.hideLabel || !label ? m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<legend class=\"", "\">", "</legend>"], ["<legend class=\"", "\">", "</legend>"])), b$b('label'), label) : '', b$b('items'), buttons.map(function (item) {
            return m$1(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"], ["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"])), RadioButton, item.value, b$b('item'), item.value === selectedValue, item.text, item.value, handleSelect);
        }));
    }
    var templateObject_1$i, templateObject_2$7, templateObject_3$3;

    var b$a = block('warning-message');
    function WarningMessage(props) {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<span class=\"", "\">\u26A0\uFE0F ", "</span>"], ["<span class=\"", "\">\u26A0\uFE0F ", "</span>"])), b$a({ theme: props.theme }), props.children);
    }
    var templateObject_1$h;

    var b$9 = block('row');
    function Row(props) {
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$9(), b$9('category'), props.name, b$9('body'), props.children);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, className, filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
            return m$1(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    ...
    function MicInfo(props) {
        ...
        return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<", " title=\"", "\" items=\"", "\"><//>"], ["<", " title=\"", "\" items=\"", "\"><//>"])), List, props.label, audioParams);
    }
    ...
    function CameraInfo(props) {
        ...
        return m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n        <", " title=\"", "\" items=\"", "\"><//>\n        ", "\n    "], ["\n        <", " title=\"", "\" items=\"", "\"><//>\n        ", "\n    "])), List, video.label, videoParams, audio ? m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<", " ...\"", "\"><//>"], ["<", " ...\"", "\"><//>"])), MicInfo, audio) : '');
    }
    var templateObject_1$d, templateObject_2$5;

    var b$7 = block('checkbox');
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$7({ checked: checked, theme: props.theme }));
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"], ["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"])), className, handleClick, ref, b$7('input'), checked, props.label);
    }
    ...
    function CameraError(props) {
        ...
        if (error.name === 'NotFoundError') {
            return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Camera not found.'));
        }
        if (error.name === 'NotAllowedError') {
            return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Camera is blocked.'));
        }
    ...
    function Camera() {
        ...
        if (!isSsr) {
            if (!navigator.mediaDevices || typeof navigator.mediaDevices.getUserMedia !== 'function') {
                return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Media Devices API is not supported.'));
            }
        }
        var showStop = Boolean(stream);
        var played = Boolean(stream);
        return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\n            <", " class=\"", "\" theme=\"", "\" onClick=\"", "\">", "<//>\n            <", " label=\"", "\" checked=\"", "\" onClick=\"", "\" //>\n        </div>\n        <div class=\"", "\">\n            <", " onSelect=\"", "\" buttons=\"", "\"><//>\n        </div>\n\n        <", " error=\"", "\" //>\n\n        <div class=\"", "\">\n            <video ref=\"", "\" class=\"", "\" />\n        </div>\n\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\n            <", " class=\"", "\" theme=\"", "\" onClick=\"", "\">", "<//>\n            <", " label=\"", "\" checked=\"", "\" onClick=\"", "\" //>\n        </div>\n        <div class=\"", "\">\n            <", " onSelect=\"", "\" buttons=\"", "\"><//>\n        </div>\n\n        <", " error=\"", "\" //>\n\n        <div class=\"", "\">\n            <video ref=\"", "\" class=\"", "\" />\n        </div>\n\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"])), b$6(), b$6('select'), Button, b$6('select-camera'), showStop ? 'red' : 'active', handleClick, stream ? i18n('Stop') : i18n('Check camera'), Checkbox, i18n('Mic'), withMic, handleMic, b$6('controls'), RadioButtons, handleSelect, buttons, CameraError, error, b$6('container', { played: played }), refVideo, b$6('video'), b$6('params'), params ? m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<", " ...", " //>"], ["<", " ...", " //>"])), CameraInfo, params) : '');
    }
    var templateObject_1$a, templateObject_2$3, templateObject_3;
