(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$a = block('lang-switcher-item');
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$a(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function LangSwitcher() {
        ...
        return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\" onClick=\"", "\"><span class=\"", "\">", "</span> ", "</div>\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"])), b$9(), b$9('current'), handleClick, b$9('emoji'), currentLangItem.emoji, currentLangItem.name, b$9('popup', { visible: visible }), langs.map(function (item) { return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"], ["<", " selected=\"", "\" key=\"", "\" onClick=\"", "\" ...\"", "\" //>"])), LangSwitcherItem, currentLang === item.value, item.value, handleClickItem, item); }));
    }
    var templateObject_1$e, templateObject_2$4;

    var b$8 = block('footer');
    function Footer() {
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"], ["<footer class=\"", "\">\n        <div class=\"", "\"><", " theme=\"white\" target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues/new\">", "<//></div>\n        <div class=\"", "\"><", " //></div>\n        <div class=\"", "\">\u00A9 Vvideo</div>\n    </footer>"])), b$8(), b$8('item', { report: true }), Link, i18n('Report a bug'), b$8('item'), LangSwitcher, b$8('item'));
    }
    var templateObject_1$d;

    var b$7 = block('main-menu');
    function MainMenu(props) {
        return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "], ["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "])), b$7(), b$7('list'), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"], ["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"])), b$7('item', { selected: item.selected }), item.id, b$7('link'), getPagePath(item.id), item.title);
        }));
    }
    ...
    function Button(props) {
        ...
        return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"])), className, disabled, handleClick, props.children);
    }
    var templateObject_1$7;

    var b$3 = block('checkbox');
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$3({ checked: checked, theme: props.theme }));
        return m$1(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"], ["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"])), className, handleClick, ref, b$3('input'), checked, props.label);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, className, filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
    ...
    function MicInfo(props) {
        ...
        return m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["<", " title=\"", "\" items=\"", "\"><//>"], ["<", " title=\"", "\" items=\"", "\"><//>"])), List, props.label, audioParams);
    }
    ...
    function Mic() {
        ...
        var selectButton = m$1(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["<", " theme=\"active\" onClick=\"", "\">", "<//>"], ["<", " theme=\"active\" onClick=\"", "\">", "<//>"])), Button, handleSelectMic, i18n('Check mic'));
        var stopButton = m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<", " theme=\"red\" onClick=\"", "\">", "<//>"], ["<", " theme=\"red\" onClick=\"", "\">", "<//>"])), Button, handleStop, i18n('Stop'));
        var streamParams = micWaveform.getStreamParams();
        return m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<div class=\"", "\">\n        ", "<", " class=\"", "\" label=\"", "\" onClick=\"", "\" />\n\n        <div class=\"", "\">\n            <canvas ref=\"", "\" class=\"", "\" width=\"300\" height=\"200\"></canvas>\n        </div>\n\n        ", "\n    </div>"], ["<div class=\"", "\">\n        ", "<", " class=\"", "\" label=\"", "\" onClick=\"", "\" />\n\n        <div class=\"", "\">\n            <canvas ref=\"", "\" class=\"", "\" width=\"300\" height=\"200\"></canvas>\n        </div>\n\n        ", "\n    </div>"])), b({ started: started }), started ? stopButton : selectButton, Checkbox, b('hear-yourself'), i18n('Hear yourself'), handleHearYourself, b('canvas-container'), refCanvas, b('canvas'), streamParams && streamParams.audio ? m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " ...\"", "\" />"], ["<", " ...\"", "\" />"])), MicInfo, streamParams.audio) : '');
    }
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), MicPage), document.querySelector('.page'));
