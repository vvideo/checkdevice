(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$f = block('link');
    function Link(props) {
        var className = classname(props.class, b$f({ theme: props.theme }));
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$c() },
            _("div", { class: b$c('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$c('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    var b$b = block('footer');
    function Footer() {
        return (_("footer", { class: b$b() },
            _("div", { class: b$b('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$b('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$b('item') }, "\u00A9 Vvideo")));
    }

    var b$a = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$a() },
            _("ul", { class: b$a('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$a('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$a('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$9({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$8 = block('header');
    function Header() {
        return (_("header", { class: b$8() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$8('logo') }),
    ...
    function PageTitle(props) {
        return (_("h1", { class: b$7() }, props.children));
    }

    var b$6 = block('page');
    function Page(props) {
        return (_("div", { class: b$6() },
            _(Header, null),
    ...
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$4({ checked: checked, theme: props.theme, focus: focus }));
        y(function () {
            if (!ref.current) {
                return;
            }
        ...
        return (_("label", { title: props.title, class: className, onClick: handleClick },
            _("input", { type: "checkbox", ref: ref, class: b$4('input'), checked: checked }),
            props.label));
    }
    ...
    var MicWaveform = /** @class */ (function () {
        function MicWaveform() {
            ...
            this.draw = function () {
                ...
                var isLight = isLightPageTheme();
                var fillStyle = isLight ? 'white' : 'black';
                var strokeStyle = isLight ? 'black' : 'white';
    ...
    var b$3 = block('section');
    function Section(props) {
        if (!props.children) {
            return null;
        }
        var className = classname(b$3(), props.class);
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$3('name') }, props.name),
            _("div", { class: b$3('body') }, props.children))) : (_("div", { class: b$3() }, props.children));
    }
    ...
    function List(props) {
        ...
        var className = classname(props.class, b$2());
    ...
    function MicInfoSsr() {
        var audioParams = [
            [i18n('Auto gain control'), (_(ValueInProgress, null))],
            [i18n('Channel count'), (_(ValueInProgress, null))],
            [i18n('Echo cancellation'), (_(ValueInProgress, null))],
            [i18n('Latency'), (_(ValueInProgress, null))],
            [i18n('Noise suppression'), (_(ValueInProgress, null))],
            [i18n('Sample rate'), (_(ValueInProgress, null))],
            [i18n('Sample size'), (_(ValueInProgress, null))],
        ];
        return (_(List, { title: i18n('Microphone name'), items: audioParams }));
    }

    var b$1 = block('error-message');
    function ErrorMessage(props) {
        var className = classname(props.class, b$1({ theme: props.theme }));
        return (_("div", { class: className },
            "\u274C ",
            props.children));
    }

    function MicError(props) {
        var error = props.error;
        if (!error) {
            return null;
        }
        if (error.name === 'NotFoundError') {
            return (_(ErrorMessage, null, i18n('Mic not found.')));
        }
        if (error.name === 'NotAllowedError') {
            return (_(ErrorMessage, null, i18n('Mic is blocked.')));
        }
    ...
    function Mic() {
        ...
        var selectButton = (_(Button, { theme: "active", onClick: handleSelectMic }, i18n('Check mic')));
        var stopButton = (_(Button, { theme: "red", onClick: handleStop }, i18n('Stop')));
        var streamParams = micWaveform.getStreamParams();
        var audio = streamParams === null || streamParams === void 0 ? void 0 : streamParams.audio;
        return (_("div", { class: b({ started: started }) },
            started ? stopButton : selectButton,
            _(Checkbox, { class: b('hear-yourself'), label: i18n('Hear yourself'), onClick: handleHearYourself, checked: !muted }),
            _(MicError, { error: error }),
            _("div", { class: b('canvas-container'), onClick: handleSelectMic },
                _("canvas", { title: i18n('Sound spectrum visualizer for mic'), ref: refCanvas, class: b('canvas'), width: "300", height: "200" }),
                _("div", { class: b('speak-up', { started: started }) },
                    "\uD83D\uDCE2 ",
                    i18n('Speak up!'))),
            isSsr ? (_(MicInfoSsr, null)) : (audio ? (_(MicInfo, __assign({}, audio))) : '')));
    }
