(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$8(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["<span class=\"", "\">'", "'</span>"], ["<span class=\"", "\">'", "'</span>"])), b$2('string'), data);
        }
        if (typeof data === 'number') {
            return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$2('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$2('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$2('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$2('function'));
        }
        if (typeof data === 'symbol') {
            return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$2('symbol'), data);
        }
        if (typeof data === 'undefined') {
            return m$1(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<span class=\"", "\">undefined</span>"], ["<span class=\"", "\">undefined</span>"])), b$2('undefined'));
        }
        if (data === null) {
            return m$1(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<span class=\"", "\">null</span>"], ["<span class=\"", "\">null</span>"])), b$2('null'));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                ...
                return m$1(templateObject_13 || (templateObject_13 = __makeTemplateObject(["[<ul>\n                ", "\n            </ul>]"], ["[<ul>\n                ", "\n            </ul>]"])), data.map(function (item, i) {
                    var arrayIndex = options.showArrayIndex ? m$1(templateObject_11 || (templateObject_11 = __makeTemplateObject([" <span class=\"", "\">", ": </span>"], [" <span class=\"", "\">", ": </span>"])), b$2('index'), i) : '';
        ...
        if (options.compactObject && level > 0) {
            return m$1(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{", "\n            ", "\n        ", "}"], ["{", "\n            ", "\n        ", "}"])), ' ', Object.keys(data).map(function (key, i, items) {
                return m$1(templateObject_14 || (templateObject_14 = __makeTemplateObject(["<span class=\"", "\">", ": </span>", "", ""], ["<span class=\"", "\">", ": </span>", "", ""])), b$2('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ', ');
            }), ' ');
        }
        var hasBraces = Boolean(options.showCurlyBracesAtRootLevel || level);
        return m$1(templateObject_17 || (templateObject_17 = __makeTemplateObject(["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""], ["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""])), hasBraces ? '{' : '', b$2('ul', { padding: hasBraces ? 'yes' : 'no' }), Object.keys(data).map(function (key, i, items) {
            return m$1(templateObject_16 || (templateObject_16 = __makeTemplateObject(["<li><span class=\"", "\">", ": </span>", "", "</li>"], ["<li><span class=\"", "\">", ": </span>", "", "</li>"])), b$2('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ',');
        }), hasBraces ? '}' : '');
    }
    var templateObject_1$5, templateObject_2$1, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16, templateObject_17;

    function TreeList(props) {
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"], ["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"])), Row, props.title, b$2(), buildData(props.data, props.options));
    }
    var templateObject_1$4;

    var b$1 = block('keycode');
    ...
    function Keycode() {
        ...
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            ", "\n            <div class=\"", "\">\n                <", " data=", " title=\"keydown event\" //>\n            </div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            ", "\n            <div class=\"", "\">\n                <", " data=", " title=\"keydown event\" //>\n            </div>\n        </div>\n    "])), b$1(), b$1('description'), i18n('Press a key to display its code.'), key ? m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$1('key', { pressed: pressed }), key) : '', b$1('keydown'), TreeList, keydownItems);
    }
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), KeycodesPage), document.querySelector('.page'));
