    ...
    ***************************************************************************** */
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return (_("span", { class: b$1('string') },
                "'",
                data,
                "'"));
        }
        if (typeof data === 'number') {
            return (_("span", { class: b$1('number') }, data));
        }
        if (typeof data === 'bigint') {
            return (_("span", { class: b$1('bigint') },
                data,
                "n"));
        }
        if (typeof data === 'boolean') {
            return (_("span", { class: b$1('boolean') }, String(data)));
        }
        if (typeof data === 'function') {
            return (_("span", { class: b$1('function') },
                "\u0192 ",
                data.name,
                "()"));
        }
        if (typeof data === 'symbol') {
            return (_("span", { class: b$1('symbol') }, data.toString()));
        }
        if (typeof data === 'undefined') {
            return (_("span", { class: b$1('undefined') }, "undefined"));
        }
        if (data === null) {
            return (_("span", { class: b$1('null') }, "null"));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                return (_("div", { class: b$1('inline') },
                    "[",
                    ' ',
                ...
                return (_("div", { class: b$1('inline') },
                    ...
                    _("ul", null, data.map(function (item, i) {
                        var arrayIndex = options.showArrayIndex ? (_("div", { class: b$1('inline') },
                            " ",
                            _("span", { class: b$1('index') },
                                i,
                                ": "))) : '';
                        return (_("li", null,
                            arrayIndex,
        ...
        return (_("div", { class: b$1('inline') },
            hasBraces ? '{' : '',
            _("ul", { class: b$1('ul', { padding: hasBraces ? 'yes' : 'no' }) }, props.map(function (key, i, items) {
                return (_("li", null,
                    _("span", { class: b$1('property') },
                        key,
                        ": "),
    ...
    function TreeList(props) {
        return (_(Section, { name: props.title },
            _("div", { class: b$1() }, buildData(props.data, props.options))));
    }
    ...
    function Keycode() {
        ...
        return (_("div", { class: b() },
            _("div", { class: b('description') }, i18n('Press a key to display its code.')),
            key ? (_("div", { class: b('key', { pressed: pressed }) }, key)) : '',
            _("div", { class: b('keydown') },
                _(TreeList, { data: keydownItems, title: "keydown event" }))));
    }
    ...
    function KeycodesPage() {
        return (_(Page, { title: i18n('Displaying key codes') },
            _(Keycode, null)));
    }
