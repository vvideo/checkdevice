(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$7() },
            _("div", { class: b$7('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$7('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    var b$6 = block('footer');
    function Footer() {
        return (_("footer", { class: b$6() },
            _("div", { class: b$6('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$6('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$6('item') }, "\u00A9 Vvideo")));
    }

    var b$5 = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$5() },
            _("ul", { class: b$5('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$5('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$5('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$4({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$3 = block('header');
    function Header() {
        return (_("header", { class: b$3() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$3('logo') }),
                    i18n('Check device online'))),
            _(ThemeSwitcher, null)));
    }

    var b$2 = block('page-title');
    function PageTitle(props) {
        return (_("h1", { class: b$2() }, props.children));
    }
    ...
    var MAX_WHEELDELTA = 10;
    function prepareDeltaY(event) {
        var coef = isMacintosh() ? -1 : 1;
    ...
    var WHEEL_ARROW_TIMEOUT = 250;
    function Mouse() {
        var _a = h(0), wheelY = _a[0], setWheelY = _a[1];
        var _b = h(false), wheelArrowUp = _b[0], setWheelArrowUp = _b[1];
        var _c = h(false), wheelArrowDown = _c[0], setWheelArrowDown = _c[1];
        var forceUpdate = useForceUpdate();
        var buttons = A({});
        // const dblClicks = useRef<Record<number, boolean>>({});
        // const dblClickTimers = useRef<Record<number, number>>({});
        var wheelArrowUpTimer = A(0);
        var wheelArrowDownTimer = A(0);
        var refRoot = A(null);
        y(function () {
        ...
        y(function () {
            ...
            var handleWheel = function (e) {
                ...
                if (deltaY < 0) {
                    ...
                    wheelArrowUpTimer.current = setTimeout(function () {
                    ...
                    wheelArrowDownTimer.current = setTimeout(function () {
                        setWheelArrowDown(false);
                    }, WHEEL_ARROW_TIMEOUT);
                }
            };
        ...
        return (_("div", { ref: refRoot, class: b() },
            _("div", { class: b('body'), title: i18n('Mouse') },
                _("div", { class: b('left-button', { pressed: buttons.current[0], /*dblClick: dblClicks.current[0]*/ }), title: i18n('Left mouse button') },
                    _("div", { class: b('text') }, i18n('Left mouse button'))),
                _("div", { class: b('middle-button', { pressed: buttons.current[1], /*dblClick: dblClicks.current[1]*/ }) },
                    _("div", { class: b('wheel'), style: "background-position-y:".concat(wheelY, "px"), title: i18n('Middle mouse button and mouse wheel') }),
                    _("div", { class: b('text') }, i18n('Middle mouse button and mouse wheel'))),
                _("div", { class: b('wheel-arrow-up', { hidden: !wheelArrowUp }) }),
                _("div", { class: b('wheel-arrow-down', { hidden: !wheelArrowDown }) }),
                _("div", { class: b('right-button', { pressed: buttons.current[2], /*dblClick: dblClicks.current[2]*/ }), title: i18n('Right mouse button') },
                    _("div", { class: b('text') }, i18n('Right mouse button'))),
                _("div", { class: b('4-button', { pressed: buttons.current[3], /*dblClick: dblClicks.current[3]*/ }), title: i18n('Additional mouse button 4') },
                    _("div", { class: b('text') }, i18n('Additional mouse button 4'))),
                _("div", { class: b('5-button', { pressed: buttons.current[4], /*dblClick: dblClicks.current[4]*/ }), title: i18n('Additional mouse button 5') },
                    _("div", { class: b('text') }, i18n('Additional mouse button 5'))))));
    }
    ...
    function MousePage() {
        return (_(Page, { title: i18n('Testing mouse') },
            _(Mouse, null)));
    }
