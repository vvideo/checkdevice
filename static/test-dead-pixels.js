(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$d = block('link');
    function Link(props) {
        var className = classname(props.class, b$d({ theme: props.theme }));
    ...
    var b$c = block('lang-icon');
    function LangIcon(props) {
        return (_("span", { class: b$c({ lang: props.lang }) }));
    }
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$a() },
            _("div", { class: b$a('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$a('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    function Footer() {
        return (_("footer", { class: b$9() },
            _("div", { class: b$9('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$9('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$9('item') }, "\u00A9 Vvideo")));
    }

    var b$8 = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$8() },
            _("ul", { class: b$8('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$8('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$8('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$7({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$6 = block('header');
    function Header() {
        return (_("header", { class: b$6() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$6('logo') }),
    ...
    function PageTitle(props) {
        return (_("h1", { class: b$5() }, props.children));
    }
    ...
    function Monitor(props) {
        return (_("div", { class: b$3() },
            _("div", { class: b$3('content') }, props.children),
            _("div", { class: b$3('rack') }),
            _("div", { class: b$3('foot') })));
    }

    var b$2 = block('screen-dead-pixels-example');
    function ScreenDeadPixelsExample() {
        return (_("div", { class: b$2() },
            _("div", { class: b$2('content') }),
            _("div", { class: b$2('dpixel1') }),
            _("div", { class: b$2('dpixel2') }),
            _("div", { class: b$2('dpixel3') })));
    }
    ...
    function Button(props) {
        ...
        var className = classname(props.class, b$1({ theme: theme, size: size, disabled: disabled }));
        var handleClick = q(function () {
            if (disabled) {
                return;
            }
    ...
    function TestDeadPixels() {
        ...
        return (_("div", { class: b({ fullscreen: isFullScreen }) },
            _(Button, { theme: "active", onClick: handleButtonClick }, i18n('Start test')),
            _("div", { class: b('content'), ref: ref, style: "background-color: ".concat(colors[step]), onClick: handleContentClick })));
    }
    ...
    function TestDeadPixelsPage() {
        return (_(Page, { title: i18n('Test dead pixels') },
            _("div", null,
                _(Monitor, null,
                    _(ScreenDeadPixelsExample, null)),
                _(TestDeadPixels, null))));
    }
    ...
    renderToRoot(TestDeadPixelsPage);
