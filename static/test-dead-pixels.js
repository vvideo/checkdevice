(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function Link(props) {
        ...
        return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"], ["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"])), props.target, className, props.href, props.children);
    }
    ...
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$9(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function MainMenu(props) {
        return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "], ["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "])), b$6(), b$6('list'), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"], ["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"])), b$6('item', { selected: item.selected }), item.id, b$6('link'), getPagePath(item.id), item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    ...
    function Page(props) {
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"], ["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"])), Header, props.withoutMenu ? '' : m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<", "><//>"], ["<", "><//>"])), Menu), props.children, Footer);
    }
    var templateObject_1$7, templateObject_2;

    var b$4 = block('monitor');
    function Monitor(props) {
        return m$1(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    "])), b$4(), b$4('content'), props.children, b$4('rack'), b$4('foot'));
    }
    var templateObject_1$6;

    var b$3 = block('screen-dead-pixels-example');
    function ScreenDeadPixelsExample() {
        return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n            <div class=\"", "\"></div>\n        </div>\n    "])), b$3(), b$3('content'), b$3('dpixel1'), b$3('dpixel2'), b$3('dpixel3'));
    }
    var templateObject_1$5;

    var b$2 = block('button');
    function Button(props) {
        var disabled = props.disabled, size = props.size, theme = props.theme, onClick = props.onClick;
        var className = classname(props.class, b$2({ theme: theme, size: size, disabled: disabled }));
        var handleClick = q(function () {
            if (disabled) {
                return;
            }
    ...
    var b$1 = block('test-dead-pixels');
    ...
    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), TestDeadPixelsPage), document.querySelector('.page'));
