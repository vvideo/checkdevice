(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$h = block('link');
    function Link(props) {
        var className = classname(props.class, b$h({ theme: props.theme }));
    ...
    var b$g = block('lang-icon');
    function LangIcon(props) {
        return (_("span", { class: b$g({ lang: props.lang }) }));
    }
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$e() },
            _("div", { class: b$e('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$e('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    function Footer() {
        return (_("footer", { class: b$d() },
            _("div", { class: b$d('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$d('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$d('item') }, "\u00A9 Vvideo")));
    }

    var b$c = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$c() },
            _("ul", { class: b$c('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$c('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$c('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$b({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$a = block('header');
    function Header() {
        return (_("header", { class: b$a() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$a('logo') }),
                    i18n('Check device online'))),
            _(ThemeSwitcher, null)));
    }

    var b$9 = block('page-title');
    function PageTitle(props) {
        return (_("h1", { class: b$9() }, props.children));
    }

    var b$8 = block('page');
    function Page(props) {
        return (_("div", { class: b$8() },
            _(Header, null),
    ...
    function Section(props) {
        ...
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$6('name') }, props.name),
            _("div", { class: b$6('body') }, props.children))) : (_("div", { class: b$6() }, props.children));
    }

    var b$5 = block('tree-list');
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return (_("span", { class: b$5('string') },
                "'",
                data,
                "'"));
        }
        if (typeof data === 'number') {
            return (_("span", { class: b$5('number') }, data));
        }
        if (typeof data === 'bigint') {
            return (_("span", { class: b$5('bigint') },
                data,
                "n"));
        }
        if (typeof data === 'boolean') {
            return (_("span", { class: b$5('boolean') }, String(data)));
        }
        if (typeof data === 'function') {
            return (_("span", { class: b$5('function') },
                "\u0192 ",
                data.name,
                "()"));
        }
        if (typeof data === 'symbol') {
            return (_("span", { class: b$5('symbol') }, data.toString()));
        }
        if (typeof data === 'undefined') {
            return (_("span", { class: b$5('undefined') }, "undefined"));
        }
        if (data === null) {
            return (_("span", { class: b$5('null') }, "null"));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                return (_("div", { class: b$5('inline') },
                    "[",
                    ' ',
                ...
                return (_("div", { class: b$5('inline') },
                    ...
                    _("ul", null, data.map(function (item, i) {
                        var arrayIndex = options.showArrayIndex ? (_("div", { class: b$5('inline') },
                            " ",
                            _("span", { class: b$5('index') },
                                i,
                                ": "))) : '';
                        return (_("li", null,
                            arrayIndex,
        ...
        return (_("div", { class: b$5('inline') },
            hasBraces ? '{' : '',
            _("ul", { class: b$5('ul', { padding: hasBraces ? 'yes' : 'no' }) }, props.map(function (key, i, items) {
                return (_("li", null,
                    _("span", { class: b$5('property') },
                        key,
                        ": "),
    ...
    function TreeList(props) {
        return (_(Section, { name: props.title },
            _("div", { class: b$5() }, buildData(props.data, props.options))));
    }

    var b$4 = block('ya-static-map');
    ...
    function YaStaticMap(props) {
        ...
        return (_("div", { class: b$4() },
            _("img", { src: url, width: props.width, height: props.height })));
    }

    var b$3 = block('spinner');
    function Spinner(props) {
        return (_("div", { class: b$3({ size: props.size }) }));
    }
    ...
    var b$1 = block('warning-message');
    function WarningMessage(props) {
        return (_("span", { class: b$1({ theme: props.theme }) },
            "\u26A0\uFE0F ",
            props.children));
    }
    ...
    function GeoLocation(props) {
        ...
        if (!isSsr && typeof ((_a = navigator.geolocation) === null || _a === void 0 ? void 0 : _a.getCurrentPosition) === 'undefined') {
            return (_(WarningMessage, null, i18n('Geo Location API is not supported.')));
        }
        ...
        return (_("div", { class: b() },
            _(Button, { disabled: inProgress, theme: "active", onClick: handleClick },
                _("span", null,
                    inProgress ? (_(Spinner, { size: "m" })) : '',
                    i18n('Request geo location'))),
            coords ? (_("div", { class: b('list') },
                _(TreeList, { data: coords }))) : '',
            error ? (_(ErrorMessage, null, error)) : '',
            coords ? (_("div", { class: b('map') },
                _(YaStaticMap, { latitude: coords.latitude, longitude: coords.longitude, width: "300", height: "300", zoom: "13", apikey: props.yaMapsApiKey }))) : null));
    }
    ...
    function GeoPage() {
        return (_(Page, { title: i18n('Geo') },
            _(GeoLocation, { yaMapsApiKey: config.yaMapsApiKey })));
    }
