(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function Link(props) {
        ...
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"], ["<a target=\"", "\" class=\"", "\" href=\"", "\">", "</a>"])), props.target, className, props.href, props.children);
    }
    ...
    function LangSwitcherItem(props) {
        ...
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"], ["<div class=\"", "\" onClick=\"", "\">", " ", " ", "</div>"])), b$b(), handleClick, emoji, name, selected ? ' ✓' : '');
    }
    ...
    function MainMenu(props) {
        return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "], ["\n        <nav class=\"", "\">\n            <ul class=\"", "\">\n            ", "\n            </ul>\n        </nav>\n    "])), b$8(), b$8('list'), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"], ["<li class=\"", "\" key=\"", "\"><a class=\"", "\" href=\"", "\">", "</a></li>"])), b$8('item', { selected: item.selected }), item.id, b$8('link'), getPagePath(item.id), item.title);
        }));
    }
    var templateObject_1$d, templateObject_2$3;
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    ...
    function Page(props) {
        return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"], ["\n        <div>\n            <", " //>\n            ", "\n\n            ", "\n\n            <", "><//>\n        </div>"])), Header, props.withoutMenu ? '' : m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<", "><//>"], ["<", "><//>"])), Menu), props.children, Footer);
    }
    var templateObject_1$a, templateObject_2$2;

    var b$6 = block('button');
    function Button(props) {
        var disabled = props.disabled, size = props.size, theme = props.theme, onClick = props.onClick;
        var className = classname(props.class, b$6({ theme: theme, size: size, disabled: disabled }));
        var handleClick = q(function () {
            if (disabled) {
                return;
            }
        ...
        return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" disabled=\"", "\" onClick=\"", "\">", "</button>"])), className, disabled, handleClick, props.children);
    }
    var templateObject_1$9;

    var b$5 = block('row');
    function Row(props) {
        return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$5(), b$5('category'), props.name, b$5('body'), props.children);
    }
    var templateObject_1$8;

    var b$4 = block('tree-list');
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<span class=\"", "\">'", "'</span>"], ["<span class=\"", "\">'", "'</span>"])), b$4('string'), data);
        }
        if (typeof data === 'number') {
            return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$4('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$4('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$4('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$4('function'));
        }
        if (typeof data === 'symbol') {
            return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$4('symbol'), data);
        }
        if (typeof data === 'undefined') {
            return m$1(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<span class=\"", "\">undefined</span>"], ["<span class=\"", "\">undefined</span>"])), b$4('undefined'));
        }
        if (data === null) {
            return m$1(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<span class=\"", "\">null</span>"], ["<span class=\"", "\">null</span>"])), b$4('null'));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                ...
                return m$1(templateObject_13 || (templateObject_13 = __makeTemplateObject(["[<ul>\n                ", "\n            </ul>]"], ["[<ul>\n                ", "\n            </ul>]"])), data.map(function (item, i) {
                    var arrayIndex = options.showArrayIndex ? m$1(templateObject_11 || (templateObject_11 = __makeTemplateObject([" <span class=\"", "\">", ": </span>"], [" <span class=\"", "\">", ": </span>"])), b$4('index'), i) : '';
        ...
        if (options.compactObject && level > 0) {
            return m$1(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{", "\n            ", "\n        ", "}"], ["{", "\n            ", "\n        ", "}"])), ' ', Object.keys(data).map(function (key, i, items) {
                return m$1(templateObject_14 || (templateObject_14 = __makeTemplateObject(["<span class=\"", "\">", ": </span>", "", ""], ["<span class=\"", "\">", ": </span>", "", ""])), b$4('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ', ');
            }), ' ');
        }
        var hasBraces = Boolean(options.showCurlyBracesAtRootLevel || level);
        return m$1(templateObject_17 || (templateObject_17 = __makeTemplateObject(["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""], ["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""])), hasBraces ? '{' : '', b$4('ul', { padding: hasBraces ? 'yes' : 'no' }), Object.keys(data).map(function (key, i, items) {
            return m$1(templateObject_16 || (templateObject_16 = __makeTemplateObject(["<li><span class=\"", "\">", ": </span>", "", "</li>"], ["<li><span class=\"", "\">", ": </span>", "", "</li>"])), b$4('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ',');
        }), hasBraces ? '}' : '');
    }
    ...
    function TreeList(props) {
        return m$1(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"], ["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"])), Row, props.title, b$4(), buildData(props.data, props.options));
    }
    var templateObject_1$6;

    var b$3 = block('ya-static-map');
    ...
    function YaStaticMap(props) {
        var url = YA_STATIC_IMAGE_URL + [
            ...
            ['z', props.zoom],
            ['apikey', props.apikey],
            ['pt', "".concat(props.longitude, ",").concat(props.latitude, ",flag")]
        ].map(function (item) {
            return "".concat(item[0], "=").concat(item[1]);
        }).join('&');
        return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["<div class=\"", "\"><img src=\"", "\" width=\"", "\" height=\"", "\" /></div>"], ["<div class=\"", "\"><img src=\"", "\" width=\"", "\" height=\"", "\" /></div>"])), b$3(), url, props.width, props.height);
    }
    var templateObject_1$5;

    var b$2 = block('spinner');
    function Spinner(props) {
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$2({ size: props.size }));
    }
    var templateObject_1$4;

    var b$1 = block('geo-location');
    ...
    function GeoPage() {
        return m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        <", ">\n            <", ">\n                ", "\n            <//>\n            <", " yaMapsApiKey=\"", "\" //>\n        <//>"], ["\n        <", ">\n            <", ">\n                ", "\n            <//>\n            <", " yaMapsApiKey=\"", "\" //>\n        <//>"])), Page, PageTitle, i18n('Geo'), GeoLocation, config.yaMapsApiKey);
    }
    var templateObject_1$1;

    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), GeoPage), document.querySelector('.page'));
