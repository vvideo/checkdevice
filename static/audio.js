(function (factory) {
    ...
    function Badge(props) {
        ...
        return (_("div", { class: b$t({
            ...
            ((_a = props.top) === null || _a === void 0 ? void 0 : _a.text) ? (_("div", { class: b$t('top-text'), title: props.top.title }, props.top.text)) : '',
            _("div", { class: b$t('body') }, props.text),
            ((_b = props.bottom) === null || _b === void 0 ? void 0 : _b.text) ? (_("div", { class: b$t('bottom-text'), title: props.bottom.title }, props.bottom.text)) : ''));
    }
    ...
    function AudioBadge() {
        ...
        return (_("div", { class: b$s() },
            _(Badge, { text: has51 ? '5.1' : '2.0', background: has51 ? 'gold' : 'transparent', bottom: {
    ...
    ***************************************************************************** */
    ...
    function AudioCodecs() {
        ...
        [
            ...
            { supported: isDolbyDigitalSupported(), name: (_("span", null,
                    _("b", null, "Dolby"),
                    " Digital")), color: 'black', border: 'white' },
            { supported: isDolbyDigitalPlusSupported(), name: (_("span", null,
                    _("b", null, "Dolby"),
                    " Digital Plus")), color: 'black', border: 'white' },
            { supported: isDolbyAtmosSupported(), name: (_("span", null,
                    _("b", null, "Dolby"),
                    " Atmos")), color: 'black', border: 'white' },
        ...
        return (_(Columns, null,
            _("div", null,
                _(Column, { title: i18n('Supported audio codecs'), name: i18n('Supported') }, supported.length ? supported : i18n('No supported audio codecs.')),
                unsupported.length ? (_(Column, { disabled: true, title: i18n('Unsupported audio codecs'), name: i18n('Unsupported') }, unsupported)) : '')));
    }
    ...
    var b$n = block('section');
    function Section(props) {
        if (!props.children) {
            return null;
        }
        var className = classname(b$n(), props.class);
        return props.name ? (_("section", { class: className },
            _("h2", { class: b$n('name') }, props.name),
            _("div", { class: b$n('body') }, props.children))) : (_("div", { class: b$n() }, props.children));
    }
    ...
    var b$m = block('link');
    function Link(props) {
        var className = classname(props.class, b$m({ theme: props.theme }));
    ...
    function LangSwitcher() {
        ...
        return (_("div", { ref: ref, class: b$j() },
            _("div", { class: b$j('current'), onClick: handleClick },
                _(LangIcon, { lang: currentLangItem.value }),
                " ",
                currentLangItem.name),
            _("menu", { class: b$j('popup', { visible: visible }) }, langs.map(function (item) {
    ...
    var b$i = block('footer');
    function Footer() {
        return (_("footer", { class: b$i() },
            _("div", { class: b$i('item', { report: true }) },
                _(Link, { theme: "page-theme", target: "_blank", href: "https://github.com/vvideo/caniwatchvideo/issues/new" }, i18n('Report a bug'))),
            _("div", { class: b$i('item') },
                _(LangSwitcher, null)),
            _("div", { class: b$i('item') }, "\u00A9 Vvideo")));
    }

    var b$h = block('main-menu');
    function MainMenu(props) {
        return (_("nav", { class: b$h() },
            _("ul", { class: b$h('list') }, props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
                return (_("li", { class: b$h('item', { selected: item.selected }), key: item.id },
                    _("a", { class: b$h('link'), href: getPagePath(item.id) }, item.title),
                    " "));
            }))));
    }
    ...
    function ThemeSwitcher() {
        ...
        return (_("div", { class: b$g({ theme: theme }), onClick: handleClick, title: title }));
    }

    var b$f = block('header');
    function Header() {
        return (_("header", { class: b$f() },
            _(Link, { theme: "page-theme", href: getPagePath('index') },
                _("span", null,
                    _("span", { class: b$f('logo') }),
                    i18n('Check device online'))),
            _(ThemeSwitcher, null)));
    }

    var b$e = block('page-title');
    function PageTitle(props) {
        return (_("h1", { class: b$e() }, props.children));
    }

    var b$d = block('page');
    function Page(props) {
        return (_("div", { class: b$d() },
            _(Header, null),
    ...
    var b$c = block('active-question');
    function ActiveQuestion(props) {
        var _a = h(false), opened = _a[0], setOpened = _a[1];
        var callback = q(function () {
            setOpened(!opened);
        }, [opened]);
        return (_("div", { class: b$c({ opened: opened }) },
            _("div", { class: b$c('head'), onClick: callback },
                _("div", { class: b$c('plus', { opened: opened }) }),
                _("div", { class: b$c('question') }, props.head)),
            _("div", { class: b$c('body') }, props.children)));
    }

    var b$b = block('result');
    function Result(props) {
        ...
        return (_("span", { class: b$b({ type: type }) },
            text,
            props.details ? (_("span", { class: b$b('details') }, props.details)) : ''));
    }

    var b$a = block('question-surround-sound');
    function QuestionSurroundSound() {
        ...
        var head = (_("span", null,
            i18n('Can I listen to surround sound on online services?'),
            '\u00a0',
            _(Result, { value: mainAnswer })));
        return (_("div", { class: b$a() },
            _(ActiveQuestion, { head: head },
                _("div", null,
                    i18n('Supports one of the audio codecs?'),
                    '\u00a0',
                    _(Result, { value: mainAnswer }),
                    _("ul", null,
                        _("li", null,
                            _(Codec, { name: "Dolby Digital", color: "black", border: "white", disabled: !isDolbyDigital.any, tooltip: CodecDetails(isDolbyDigital) }),
                            '\u00a0',
                            _(Result, { value: isDolbyDigital.any })),
                        _("li", null,
                            _(Codec, { name: "Dolby Digital Plus", color: "black", border: "white", disabled: !isDolbyDigitalPlus.any, tooltip: CodecDetails(isDolbyDigitalPlus) }),
                            '\u00a0',
                            _(Result, { value: isDolbyDigitalPlus.any })),
                        _("li", null,
                            _(Codec, { name: "Dolby Atmos", color: "black", border: "white", disabled: !isDolbyAtmos }),
                            '\u00a0',
                            _(Result, { value: isDolbyAtmos })),
                        _("li", null,
                            _(Codec, { name: "DTS", color: "black", border: "white", disabled: !isDts.any, tooltip: CodecDetails(isDts) }),
                            '\u00a0',
                            _(Result, { value: isDts.any })),
                        _("li", null,
                            _(Codec, { name: "DTS:HD", color: "black", border: "white", disabled: !isDtsHd.any, tooltip: CodecDetails(isDtsHd) }),
                            '\u00a0',
                            _(Result, { value: isDtsHd.any })),
                        _("li", null,
                            _(Codec, { name: "DTS:X", color: "black", border: "white", disabled: !isDtsX.any, tooltip: CodecDetails(isDtsX) }),
                            '\u00a0',
                            _(Result, { value: isDtsX.any })))))));
    }

    var b$9 = block('button');
    function Button(props) {
        var disabled = props.disabled, size = props.size, theme = props.theme, onClick = props.onClick, title = props.title;
        var className = classname(props.class, b$9({ theme: theme, size: size, disabled: disabled }));
        var handleClick = q(function () {
            if (disabled) {
                return;
            }
    ...
    function Vibration() {
        ...
        return (_(Section, { class: b$7(), name: i18n('Vibration') },
            _("div", null,
                _(Button, { onClick: onClick, title: i18n('Check vibration') }, i18n('Vibrate')),
                !isSsr && isMobile() ? '' : (_("div", { class: b$7('details') },
                    _(WarningMessage, { theme: "gray" }, i18n('Support is mainly on mobile devices.')))))));
    }
    ...
    function Input(props) {
        var className = classname(b$6(), props.class);
        ...
        return (_("input", { class: className, ref: ref, title: props.title, onKeyPress: handleKeyPress, onInput: handleInput, placeholder: props.placeholder, value: value }));
    }

    var b$5 = block('info-link');
    function InfoLink(props) {
        return (_("span", { class: b$5() },
            _("a", { class: b$5('link'), href: props.href, title: props.title, target: "_blank" }, "\u24D8")));
    }

    var b$4 = block('speech-synthesis');
    function SpeechSynthesis() {
        var _a = h(i18n('Hello world!')), text = _a[0], setText = _a[1];
        function speech() {
            var ssu = new SpeechSynthesisUtterance(text);
            window.speechSynthesis.speak(ssu);
        }
        var handleSpeak = q(function () {
            speech();
        }, [speech]);
        var handleKeyPress = q(function (event) {
            if (event.code === 'Enter') {
        ...
        var handleInput = q(function (value) {
            setText(value);
        }, [setText]);
        var isSupported = typeof SpeechSynthesis === 'function' && typeof speechSynthesis !== 'undefined';
        return (_("div", { class: b$4() },
            isSupported && !isSsr ? '' : (_("div", { class: b$4('supported') },
                "Web Speech API",
                _(InfoLink, { title: "MDN", href: "https://developer.mozilla.org/en-US/docs/Web/API/SpeechSynthesis" }),
                ": ",
                getChecked(isSupported))),
            isSupported || isSsr ? (_("div", { class: b$4('form') },
                _(Input, { class: b$4('input'), title: i18n('Input text for speech synthesis'), placeholder: i18n('Input text'), value: text, onKeyPress: handleKeyPress, onChange: handleInput }),
                " ",
                _(Button, { onClick: handleSpeak, title: i18n('Speak words') }, i18n('Speak')))) : ''));
    }
    ...
    var b$2 = block('error-message');
    function ErrorMessage(props) {
        var className = classname(props.class, b$2({ theme: props.theme }));
        return (_("div", { class: className },
            "\u274C ",
            props.children));
    }

    function AudioError(props) {
        ...
        return (_(ErrorMessage, null, text));
    }

    var b$1 = block('audio-inputs-outputs');
    function AudioInputsOutputs() {
        var _a = h(null), error = _a[0], setError = _a[1];
        var _b = h([]), outputs = _b[0], setOutputs = _b[1];
        var _c = h([]), inputs = _c[0], setInputs = _c[1];
        var handleClick = q(function () {
        ...
        var inputItems = inputs.map(function (item) { return [item]; });
        var outputItems = outputs.map(function (item) { return [item]; });
        return (_("div", { class: b$1() },
            _(Button, { onClick: handleClick }, i18n('Request inputs and outputs')),
            _(AudioError, { error: error }),
            inputItems.length || outputs.length ? (_("div", { class: b$1('lists') },
                _("div", { class: b$1('list') },
                    "\uD83C\uDF99\uFE0F ",
                    i18n('Inputs'),
                    _("br", null),
                    inputItems.length ? (_(List, { class: b$1('list'), items: inputItems })) : i18n('Not detected.')),
                _("div", { class: b$1('list') },
                    "\uD83D\uDD08 ",
                    i18n('Outputs'),
                    _("br", null),
                    outputItems.length ? (_(List, { class: b$1('list'), items: outputItems })) : i18n('Not detected.')))) : null));
    }
    ...
    var keyset = {
        ...
        'Access denied.': {
            'en': 'Access denied.',
            'ru': 'Доступ не разрешён.'
        },
        'Hardware error has occurred that prevents access to the device.': {
            'en': 'Hardware error has occurred that prevents access to the device.',
            'ru': 'Произошла аппаратная ошибка, которая препятствует доступу к устройству.'
        },
    ...
    var b = block('audio-page');
    addI18nKeyset(keyset);
    function AudioPage() {
        return (_(Page, { title: i18n('Audio') },
            _("div", null,
                _(QuestionSurroundSound, null),
                _("div", { class: b('badge') },
                    _(AudioBadge, null)),
                _(Section, { name: i18n('Audio Codecs') },
                    _(AudioCodecs, null)),
                _(Section, { name: i18n('Audio Inputs and Outputs') },
                    _(AudioInputsOutputs, null)),
                _(Section, { name: i18n('Speech Synthesis') },
                    _(SpeechSynthesis, null)),
                _(Vibration, null))));
    }
