(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$c = block('row');
    function Row(props) {
        return m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$c(), b$c('category'), props.name, b$c('body'), props.children);
    }
    var templateObject_1$i;

    var b$b = block('tree-list');
    ...
    function buildData(data, options, level) {
        ...
        if (typeof data === 'string') {
            return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<span class=\"", "\">'", "'</span>"], ["<span class=\"", "\">'", "'</span>"])), b$b('string'), data);
        }
        if (typeof data === 'number') {
            return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$b('number'), data);
        }
        if (typeof data === 'bigint') {
            return m$1(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["<span class=\"", "\">", "n</span>"], ["<span class=\"", "\">", "n</span>"])), b$b('bigint'), data);
        }
        if (typeof data === 'boolean') {
            return m$1(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$b('boolean'), String(data));
        }
        if (typeof data === 'function') {
            return m$1(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["<span class=\"", "\">function</span>"], ["<span class=\"", "\">function</span>"])), b$b('function'));
        }
        if (typeof data === 'symbol') {
            return m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<span class=\"", "\">", "</span>"], ["<span class=\"", "\">", "</span>"])), b$b('symbol'), data);
        }
        if (typeof data === 'undefined') {
            return m$1(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<span class=\"", "\">undefined</span>"], ["<span class=\"", "\">undefined</span>"])), b$b('undefined'));
        }
        if (data === null) {
            return m$1(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<span class=\"", "\">null</span>"], ["<span class=\"", "\">null</span>"])), b$b('null'));
        }
        if (Array.isArray(data)) {
            if (options.compactArrayWithSimpleTypes && isArrayWithSimpleTypes(data)) {
                ...
                return m$1(templateObject_13 || (templateObject_13 = __makeTemplateObject(["[<ul>\n                ", "\n            </ul>]"], ["[<ul>\n                ", "\n            </ul>]"])), data.map(function (item, i) {
                    var arrayIndex = options.showArrayIndex ? m$1(templateObject_11 || (templateObject_11 = __makeTemplateObject([" <span class=\"", "\">", ": </span>"], [" <span class=\"", "\">", ": </span>"])), b$b('index'), i) : '';
        ...
        if (options.compactObject && level > 0) {
            return m$1(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{", "\n            ", "\n        ", "}"], ["{", "\n            ", "\n        ", "}"])), ' ', Object.keys(data).map(function (key, i, items) {
                return m$1(templateObject_14 || (templateObject_14 = __makeTemplateObject(["<span class=\"", "\">", ": </span>", "", ""], ["<span class=\"", "\">", ": </span>", "", ""])), b$b('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ', ');
            }), ' ');
        }
        var hasBraces = Boolean(options.showCurlyBracesAtRootLevel || level);
        return m$1(templateObject_17 || (templateObject_17 = __makeTemplateObject(["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""], ["", "<ul class=\"", "\">\n        ", "\n    </ul>", ""])), hasBraces ? '{' : '', b$b('ul', { padding: hasBraces ? 'yes' : 'no' }), Object.keys(data).map(function (key, i, items) {
            return m$1(templateObject_16 || (templateObject_16 = __makeTemplateObject(["<li><span class=\"", "\">", ": </span>", "", "</li>"], ["<li><span class=\"", "\">", ": </span>", "", "</li>"])), b$b('property'), key, buildData(data[key], options, level + 1), i === items.length - 1 ? '' : ',');
        }), hasBraces ? '}' : '');
    }
    var templateObject_1$h, templateObject_2$4, templateObject_3$3, templateObject_4$1, templateObject_5$1, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14, templateObject_15, templateObject_16, templateObject_17;

    function TreeList(props) {
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"], ["\n        <", " name=\"", "\">\n            <div class=\"", "\">\n                ", "\n            </div>\n        <//>"])), Row, props.title, b$b(), buildData(props.data, props.options));
    }
    var templateObject_1$g;

    var b$a = block('connection-navigator');
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, b$9(), filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
            return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    var templateObject_1$e, templateObject_2$3, templateObject_3$2;

    var b$8 = block('spinner');
    function Spinner(props) {
        return m$1(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$8({ size: props.size }));
    }
    ...
    function IP() {
        ...
        var items = [
            ['IPv4', ipv4 || m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<", " size=\"s\" //>"], ["<", " size=\"s\" //>"])), Spinner)],
            ['IPv6', ipv6 || m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["<", " size=\"s\" //>"], ["<", " size=\"s\" //>"])), Spinner)]
        ];
        return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", " items=\"", "\" //>"], ["<", " items=\"", "\" //>"])), List, items);
    }
    var templateObject_1$c, templateObject_2$2, templateObject_3$1;

    var b$7 = block('network-information');
    function NetworkInformation() {
        return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n        <div class=\"", "\">\n            <", " //>\n            <", " //>\n        </div>"], ["\n        <div class=\"", "\">\n            <", " //>\n            <", " //>\n        </div>"])), b$7(), IP, ConnectionNavigator);
    }
    ...
    var b$6 = block('link');
    function Link(props) {
        return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$6({ theme: props.theme }), props.href, props.children);
    }
    ...
    function MainMenu(props) {
        return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$4(), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$4('item', { selected: item.selected }), item.url, item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    ...
    function Button(props) {
        var className = classname(props.class, b$2({ theme: props.theme, size: props.size }));
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<button class=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" onClick=\"", "\">", "</button>"])), className, props.onClick, props.children);
    }
    ...
    function GeoLocation(props) {
        var _a;
        if (typeof ((_a = navigator.geolocation) === null || _a === void 0 ? void 0 : _a.getCurrentPosition) === 'undefined') {
            return '';
        }
    ...
    function NetworkPage() {
        return m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        <", ">\n            <", ">\n                ", "\n            <//>\n            <", "><//>\n            <", " yaMapsApiKey=\"", "\" //>\n        <//>"], ["\n        <", ">\n            <", ">\n                ", "\n            <//>\n            <", "><//>\n            <", " yaMapsApiKey=\"", "\" //>\n        <//>"])), Page, Header, i18n('Network & geo'), NetworkInformation, GeoLocation, config.yaMapsApiKey);
    }
    var templateObject_1$1;

    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), NetworkPage), document.querySelector('.page'));
