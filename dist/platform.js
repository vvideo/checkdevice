(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$6 = block('link');
    function Link(props) {
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$6({ theme: props.theme }), props.href, props.children);
    }
    ...
    function MainMenu(props) {
        return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$4(), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$4('item', { selected: item.selected }), item.url, item.title);
        }));
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, b$1(), filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
    ...
    var b = block('info-link');
    function InfoLink(props) {
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<span class=\"", "\">\n        <a class=\"", "\" href=\"", "\" title=\"", "\" target=\"_blank\">\u24D8</a>\n    </span>"], ["<span class=\"", "\">\n        <a class=\"", "\" href=\"", "\" title=\"", "\" target=\"_blank\">\u24D8</a>\n    </span>"])), b(), b('link'), props.href, props.title);
    }
    ...
    function Platform() {
        ...
        // @ts-ignore
        (_b = (_a = navigator.userAgentData) === null || _a === void 0 ? void 0 : _a.getHighEntropyValues) === null || _b === void 0 ? void 0 : _b.call(_a, [
            'architecture',
            'bitness',
            'formFactor',
            'fullVersionList',
        ...
        var items = [
            [
                m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["Hardware concurrency <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/hardwareConcurrency\"><//>"], ["Hardware concurrency <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/hardwareConcurrency\"><//>"])), InfoLink),
        ...
        if (navigator.deviceMemory) {
            items.unshift([
                m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", " <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/deviceMemory\"><//>"], ["", " <", " title=\"MDN\" href=\"https://developer.mozilla.org/en-US/docs/Web/API/Navigator/deviceMemory\"><//>"])), i18n('RAM'), InfoLink),
    ...
    function Permissions() {
        ...
        return done ? m$1(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["<", " title=\"", "\" items=\"", "\" //>"], ["<", " title=\"", "\" items=\"", "\" //>"])), List, i18n('Permissions'), items) :
            '';
    }
    var templateObject_1$2;

    function PlatformPage() {
        return m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        <", ">\n            <", ">\n                ", "\n            <//>\n\n            <", " //>\n\n            <", " //>\n        <//>"], ["\n        <", ">\n            <", ">\n                ", "\n            <//>\n\n            <", " //>\n\n            <", " //>\n        <//>"])), Page, Header, i18n('Platform'), Platform, Permissions);
    }
