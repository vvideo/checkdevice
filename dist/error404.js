(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$4 = block('header');
    function Header(props) {
        return m(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$4(), props.children);
    }
    ...
    var b$3 = block('link');
    function Link(props) {
        return m(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$3({ theme: props.theme }), props.href, props.children);
    }
    var templateObject_1$7;

    var b$2 = block('footer');
    function Footer() {
        return m(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"])), b$2(), b$2('item'), b$2('l1'), b$2('l2'), b$2('l3'), b$2('l4'), b$2('l5'), b$2('l6'), b$2('item', { g: true }), Link, i18n('Report a bug'));
    }
    var templateObject_1$6;

    var b$1 = block('main-menu');
    function MainMenu(props) {
        return m(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$1(), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$1('item', { selected: item.selected }), item.url, item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    var templateObject_1$4;

    var b = block('head');
    function Head() {
        return m(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <span class=\"", "\"></span>", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <span class=\"", "\"></span>", "\n        </div>\n    "])), b(), b('logo'), i18n('Check device online'));
    }
    var templateObject_1$3;

    function Page(props) {
        return m(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n        <div>\n            <", " //>\n            <", "><//>\n\n            ", "\n\n            <", "><//>\n        </div>"], ["\n        <div>\n            <", " //>\n            <", "><//>\n\n            ", "\n\n            <", "><//>\n        </div>"])), Head, Menu, props.children, Footer);
    }
    var templateObject_1$2;

    function Error404Page() {
        return m(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        <", ">\n            <", ">404<//>\n\n            <p>", "</p>\n            <p><", " href=\"/\">", "><//></p>\n        <//>"], ["\n        <", ">\n            <", ">404<//>\n\n            <p>", "</p>\n            <p><", " href=\"/\">", "><//></p>\n        <//>"])), Page, Header, i18n('Page not found.'), Link, i18n('Go to main page'));
    }
    var templateObject_1$1;

    B(m(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), Error404Page), document.querySelector('.page'));
