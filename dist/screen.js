(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$e = block('row');
    function Row(props) {
        return m$1(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$e(), b$e('category'), props.name, b$e('body'), props.children);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, b$d(), filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
    ...
    function WarningMessage(props) {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<span>\u26A0\uFE0F ", "</span>"], ["<span>\u26A0\uFE0F ", "</span>"])), props.children);
    }
    var templateObject_1$h;

    var b$c = block('hdr-label');
    function HdrLabel(props) {
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<span class=\"", "\">HDR</span>"], ["<span class=\"", "\">HDR</span>"])), b$c({ enabled: props.enabled }));
    }
    var templateObject_1$g;

    var b$b = block('color-space-item');
    function ColorSpaceItem(props) {
        var name = props.name, supported = props.supported, type = props.type;
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<span class=\"", "\"><span class=\"", "\">", "</span> <span class=\"", "\">", "</span></span>"], ["<span class=\"", "\"><span class=\"", "\">", "</span> <span class=\"", "\">", "</span></span>"])), b$b({ type: type, supported: supported }), b$b('checked'), supported ? '✓' : '✗', b$b('color'), name);
    }
    ...
    var b$a = block('color-space-list');
    ...
    function ScreenItem(props) {
        ...
        var items = [
            ...
            [i18n('Color spaces'), m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<", " items=\"", "\" //>"], ["<", " items=\"", "\" //>"])), ColorSpaceList, colorSpaces)],
        ...
        return m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n            <", " items=\"", "\"><//>\n\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n            <", " items=\"", "\"><//>\n\n            ", "\n        </div>\n    "])), b$9(), label ? m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$9('label'), label) : '', List, items, isExtended === true ? m$1(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Additional monitor detected')) : '');
    }
    var templateObject_1$d, templateObject_2$4, templateObject_3$1, templateObject_4$1, templateObject_5;
    ...
    var b$8 = block('button');
    function Button(props) {
        var className = classname(props.class, b$8({ theme: props.theme, size: props.size }));
    ...
    var RefreshRateController = /** @class */ (function () {
        ...
        RefreshRateController.hasSupport = function () {
            var _a;
            return Boolean(typeof ((_a = window.performance) === null || _a === void 0 ? void 0 : _a.now) === 'function' &&
    ...
    function RefreshRate() {
        ...
        return value ? m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<span class=\"", "\">", " ", "</span>"], ["<span class=\"", "\">", " ", "</span>"])), b$5(), value.toFixed(3), i18n('Hz')) : m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<", " size=\"s\" //>"], ["<", " size=\"s\" //>"])), Spinner);
    }
    var templateObject_1$9, templateObject_2$3;

    var b$4 = block('screen-list');
    function ScreenList() {
        var forceUpdate = useForceUpdate();
        ...
        var additionalItems = [
            RefreshRateController.hasSupport() ? [i18n('Refresh rate'), m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), RefreshRate)] : undefined,
            [i18n('Has touch screen'), getChecked(hasTouchScreen())],
            [i18n('Max touch points'), getMaxTouchPoints()],
        ];
        var screenInfoData = screenInfo.get();
        return m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<div class=\"", "\">\n        <", ">\n            ", "\n        <//>\n\n        ", "\n\n        ", "\n\n        <", " title=\"", "\" items=\"", "\" //>\n    </div>"], ["<div class=\"", "\">\n        <", ">\n            ", "\n        <//>\n\n        ", "\n\n        ", "\n\n        <", " title=\"", "\" items=\"", "\" //>\n    </div>"])), b$4(), Header, screenInfoData.screens.length === 1 ? i18n('Screen') : i18n('Screens'), !screenInfo.isDenied && screenInfo.needUserActivity ? m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["<div class=\"", "\"><", " theme=\"red\" size=\"s\" onClick=\"", "\">", "</button></div>"], ["<div class=\"", "\"><", " theme=\"red\" size=\"s\" onClick=\"", "\">", "</button></div>"])), b$4('specify'), Button, handleClick, i18n('Specify')) : '', screenInfoData.screens.map(function (item) {
            return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " ...", "><//>"], ["<", " ...", "><//>"])), ScreenItem, item);
        }), List, i18n('Additionally'), additionalItems);
    }
    var templateObject_1$8, templateObject_2$2, templateObject_3, templateObject_4;
    ...
    function ScreenPage() {
        var items = [
            [m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["<", " href=\"./test-dead-pixels.html\">", "<//>"], ["<", " href=\"./test-dead-pixels.html\">", "<//>"])), Link, i18n('Test dead pixels'))]
        ];
