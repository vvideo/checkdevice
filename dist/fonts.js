(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function Button(props) {
        var className = classname(props.class, b$5({ theme: props.theme, size: props.size }));
        return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<button class=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" onClick=\"", "\">", "</button>"])), className, props.onClick, props.children);
    }
    ...
    function Fonts() {
        ...
        console.log(fonts);
        return m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <", " theme=\"active\" onClick=\"", "\">", "<//>\n\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <", " theme=\"active\" onClick=\"", "\">", "<//>\n\n            <ul class=\"", "\">\n                ", "\n            </ul>\n        </div>\n    "])), b$4(), Button, handleClick, i18n('Request'), b$4('list'), fonts ? fonts.map(function (item, i) {
            return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<li>", ". ", "</li>"], ["<li>", ". ", "</li>"])), i + 1, item.fullName);
        }) : undefined);
    }
