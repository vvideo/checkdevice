(function (factory) {
    ...
    ***************************************************************************** */
    ...
    function getStreamParams(stream) {
        ...
        return {
            video: {
                width: videoSettings === null || videoSettings === void 0 ? void 0 : videoSettings.width,
                height: videoSettings === null || videoSettings === void 0 ? void 0 : videoSettings.height,
                label: video === null || video === void 0 ? void 0 : video.label,
                frameRate: videoSettings === null || videoSettings === void 0 ? void 0 : videoSettings.frameRate,
            },
            audio: {
                label: audio === null || audio === void 0 ? void 0 : audio.label,
            },
        };
    }
    ...
    function Button(props) {
        var className = classname(props.class, b$a({ theme: props.theme, size: props.size }));
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<button class=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" onClick=\"", "\">", "</button>"])), className, props.onClick, props.children);
    }
    var templateObject_1$h;

    var b$9 = block('radio-button');
    function RadioButton(props) {
        var handleClick = q(function () {
            var _a;
            (_a = props.onClick) === null || _a === void 0 ? void 0 : _a.call(props, props.value);
        }, [props.onClick]);
        var className = classname(b$9({ selected: props.selected }), props.class);
        return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n        <span\n            class=\"", "\"\n            onClick=\"", "\"\n            key=\"", "\"\n        >", "</span>\n    "], ["\n        <span\n            class=\"", "\"\n            onClick=\"", "\"\n            key=\"", "\"\n        >", "</span>\n    "])), className, handleClick, props.value, props.text);
    }
    var templateObject_1$g;

    var b$8 = block('radio-buttons');
    ...
    function RadioButtons(props) {
        ...
        return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\">\n                ", "\n            </div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\">\n                ", "\n            </div>\n        </div>\n    "])), classname(b$8(), className), b$8('label'), label, b$8('items'), buttons.map(function (item) {
            return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"], ["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"])), RadioButton, item.value, b$8('item'), item.value === selectedValue, item.text, item.value, handleSelect);
        }));
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, b$6(), filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
            return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<li>", ": ", "</li>"], ["<li>", ": ", "</li>"])), name, value);
        })) : '';
    }
    var templateObject_1$c, templateObject_2$3, templateObject_3$2;
    ...
    function Checkbox(props) {
        ...
        var className = classname(props.class, b$5({ checked: checked, theme: props.theme }));
        return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"], ["<label class=\"", "\" onClick=\"", "\">\n        <input autocomplete=\"off\" ref=\"", "\" class=\"", "\" type=\"checkbox\" checked=\"", "\" />", "\n    </label>"])), className, handleClick, ref, b$5('input'), checked, props.label);
    }
    ...
    function CameraError(props) {
        ...
        if (error.name === 'NotFoundError') {
            return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Camera not found.'));
        }
        if (error.name === 'NotAllowedError') {
            return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Camera is blocked.'));
        }
        return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, error.message);
    }
    var templateObject_1$9, templateObject_2$2, templateObject_3$1;

    var b$4 = block('camera');
    function Camera() {
        var buttons = [
            {
        ...
        if (!navigator.mediaDevices || typeof navigator.mediaDevices.getUserMedia !== 'function') {
            return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<", ">", "<//>"], ["<", ">", "<//>"])), WarningMessage, i18n('Media Devices API is not supported.'));
        }
        var showStop = Boolean(stream);
        var played = Boolean(stream);
        return m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\n            <", " class=\"", "\" theme=\"", "\" onClick=\"", "\">", "<//>\n            <", " label=\"", "\" checked=\"", "\" onClick=\"", "\" //>\n        </div>\n        <div class=\"", "\">\n            <", " onSelect=\"", "\" buttons=\"", "\"><//>\n        </div>\n\n        <", " error=\"", "\" //>\n\n        <div class=\"", "\">\n            <video ref=\"", "\" class=\"", "\" />\n        </div>\n\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\n            <", " class=\"", "\" theme=\"", "\" onClick=\"", "\">", "<//>\n            <", " label=\"", "\" checked=\"", "\" onClick=\"", "\" //>\n        </div>\n        <div class=\"", "\">\n            <", " onSelect=\"", "\" buttons=\"", "\"><//>\n        </div>\n\n        <", " error=\"", "\" //>\n\n        <div class=\"", "\">\n            <video ref=\"", "\" class=\"", "\" />\n        </div>\n\n        <div class=\"", "\">\n            ", "\n        </div>\n    </div>"])), b$4(), b$4('select'), Button, b$4('select-camera'), showStop ? 'red' : 'active', handleClick, stream ? i18n('Stop') : i18n('Select camera'), Checkbox, i18n('Mic'), withMic, handleMic, b$4('controls'), RadioButtons, handleSelect, buttons, CameraError, error, b$4('container', { played: played }), refVideo, b$4('video'), b$4('params'), params ? m$1(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["<", " ...", " //>"], ["<", " ...", " //>"])), CameraInfo, params) : '');
    }
    var templateObject_1$8, templateObject_2$1, templateObject_3;
    ...
    function CameraPage() {
        return m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        <", ">\n            <", ">", "<//>\n            <", "><//>\n        <//>"], ["\n        <", ">\n            <", ">", "<//>\n            <", "><//>\n        <//>"])), Page, Header, i18n('Webcamera'), Camera);
    }
    var templateObject_1$1;

    B$1(m$1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<", " //>"], ["<", " //>"])), CameraPage), document.querySelector('.page'));
