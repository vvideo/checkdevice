(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$8 = block('link');
    function Link(props) {
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$8({ theme: props.theme }), props.href, props.children);
    }
    var templateObject_1$c;

    var b$7 = block('footer');
    function Footer() {
        return m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"])), b$7(), b$7('item'), b$7('l1'), b$7('l2'), b$7('l3'), b$7('l4'), b$7('l5'), b$7('l6'), b$7('item', { g: true }), Link, i18n('Report a bug'));
    }
    var templateObject_1$b;

    var b$6 = block('main-menu');
    function MainMenu(props) {
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$6(), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$6('item', { selected: item.selected }), item.url, item.title);
        }));
    }
    ...
    var b$1 = block('button');
    function Button(props) {
        var className = classname(props.class, b$1({ theme: props.theme, size: props.size }));
        return m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["<button class=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" onClick=\"", "\">", "</button>"])), className, props.onClick, props.children);
    }
