(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var b$d = block('link');
    function Link(props) {
        return m$1(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$d({ theme: props.theme }), props.href, props.children);
    }
    var templateObject_1$i;

    var b$c = block('footer');
    function Footer() {
        return m$1(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">\u00A9 <span class=\"", "\">V</span><span class=\"", "\">v</span><span class=\"", "\">i</span><span class=\"", "\">d</span><span class=\"", "\">e</span><span class=\"", "\">o</span></div>\n        <div class=\"", "\"><", " target=\"_blank\" href=\"https://github.com/vvideo/caniwatchvideo/issues\">", "<//></div>\n    </div>"])), b$c(), b$c('item'), b$c('l1'), b$c('l2'), b$c('l3'), b$c('l4'), b$c('l5'), b$c('l6'), b$c('item', { g: true }), Link, i18n('Report a bug'));
    }
    var templateObject_1$h;

    var b$b = block('main-menu');
    function MainMenu(props) {
        return m$1(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            ", "\n        </div>\n    "])), b$b(), props.items.filter(function (item) { return !item.hidden; }).map(function (item) {
            return m$1(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["<a class=\"", "\" href=\"", "\">", "</a>"], ["<a class=\"", "\" href=\"", "\">", "</a>"])), b$b('item', { selected: item.selected }), item.url, item.title);
        }));
    }
    ...
    function Menu() {
        ...
        return m$1(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["<", " items=\"", "\"><//>"], ["<", " items=\"", "\"><//>"])), MainMenu, items);
    }
    var templateObject_1$f;

    var b$a = block('head');
    function Head() {
        return m$1(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n        <div class=\"", "\">\n            <span class=\"", "\"></span>", "\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <span class=\"", "\"></span>", "\n        </div>\n    "])), b$a(), b$a('logo'), i18n('Check device online'));
    }
    ...
    function Button(props) {
        var className = classname(props.class, b$9({ theme: props.theme, size: props.size }));
        return m$1(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["<button class=\"", "\" onClick=\"", "\">", "</button>"], ["<button class=\"", "\" onClick=\"", "\">", "</button>"])), className, props.onClick, props.children);
    }
    ...
    function KeyboardKey(props) {
        ...
        return m$1(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n        <div class=\"", "\">\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n        </div>"], ["\n        <div class=\"", "\">\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n            ", "\n        </div>"])), b$8({ align: keyData.align, code: keyData.code, pressed: state.pressed, wasPressed: state.wasPressed, view: keyData.view, fontSize: keyData.fontSize }), keyData.text || '', keyData.topSymbol ? m$1(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('top-symbol'), keyData.topSymbol) : '', keyData.topLeftSymbol ? m$1(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('top-left-symbol'), keyData.topLeftSymbol) : '', keyData.topRightSymbol ? m$1(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('top-right-symbol'), keyData.topRightSymbol) : '', keyData.bottomLeftSymbol ? m$1(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('bottom-left-symbol'), keyData.bottomLeftSymbol) : '', keyData.bottomRightSymbol ? m$1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('bottom-right-symbol'), keyData.bottomRightSymbol) : '', keyData.bottomSymbol ? m$1(templateObject_6 || (templateObject_6 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('bottom-symbol'), keyData.bottomSymbol) : '', keyData.bottomText ? m$1(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$8('bottom-text'), keyData.bottomText) : '', typeof keyData.led === 'boolean' ? m$1(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$8('led', { on: state.led })) : '');
    }
    var templateObject_1$b, templateObject_2$5, templateObject_3$2, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9;

    var b$7 = block('keyboard-led');
    function KeyboardLed(props) {
        ...
        return m$1(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$7({ on: state.led, code: props.code }));
    }
    var templateObject_1$a;

    var b$6 = block('keyboard-spacer');
    function KeyboardSpacer(props) {
        return m$1(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["<div class=\"", "\"></div>"], ["<div class=\"", "\"></div>"])), b$6({ name: props.name }));
    }
    ...
    function KeyboardRow(props) {
        ...
        return rowData.map(function (item, i) {
            if (item.type === 'spacer') {
                return m$1(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["<", " key=\"", "\" name=\"", "\" //>"], ["<", " key=\"", "\" name=\"", "\" //>"])), KeyboardSpacer, i, item.name);
            }
            if (item.type === 'led') {
                return m$1(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["<", " key=\"", "\" code=\"", "\" //>"], ["<", " key=\"", "\" code=\"", "\" //>"])), KeyboardLed, i, item.code);
            }
            return m$1(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["<", " key=\"", "\" keyData=\"", "\" //>"], ["<", " key=\"", "\" keyData=\"", "\" //>"])), KeyboardKey, i, item);
        });
    }
    var templateObject_1$8, templateObject_2$4, templateObject_3$1;

    var b$5 = block('keyboard-layout');
    function KeyboardLayout(props) {
        var layout = props.layout;
        var items = layout.rows.map(function (rowData, num) {
            return m$1(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n            <div key=\"", "\" class=\"", "\">\n                <", " rowData=\"", "\" //>\n            </div>\n        "], ["\n            <div key=\"", "\" class=\"", "\">\n                <", " rowData=\"", "\" //>\n            </div>\n        "])), num, b$5('row', { num: num }), KeyboardRow, rowData);
        });
        return m$1(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["<div class=\"", "\">", "</div>"], ["<div class=\"", "\">", "</div>"])), b$5({ type: layout.type }), items);
    }
    ...
    function RadioButtons(props) {
        ...
        return m$1(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\">\n                ", "\n            </div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">", "</div>\n            <div class=\"", "\">\n                ", "\n            </div>\n        </div>\n    "])), classname(b$3(), className), b$3('label'), label, b$3('items'), buttons.map(function (item) {
            return m$1(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"], ["<", "\n                            key=\"", "\"\n                            class=\"", "\"\n                            selected=\"", "\"\n                            text=\"", "\"\n                            value=\"", "\"\n                            onClick=\"", "\"\n                        ><//>"])), RadioButton, item.value, b$3('item'), item.value === selectedValue, item.text, item.value, handleSelect);
        }));
    }
    ...
    var selectedPlatform = isMacintosh() ? 'mac' : 'win';
    var buttons = [
        {
            text: 'Win',
            value: 'win',
    ...
    function Keyboard() {
        ...
        return m$1(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                <", " onSelect=\"", "\" buttons=\"", "\"><//>\n            </div>\n\n            <", " layout=\"", "\" //>\n\n            <div class=\"", "\">\n                <", " size=\"m\" onClick=\"", "\">", "<//>\n            </div>\n        </div>\n    "], ["\n        <div class=\"", "\">\n            <div class=\"", "\">\n                <", " onSelect=\"", "\" buttons=\"", "\"><//>\n            </div>\n\n            <", " layout=\"", "\" //>\n\n            <div class=\"", "\">\n                <", " size=\"m\" onClick=\"", "\">", "<//>\n            </div>\n        </div>\n    "])), b$2(), b$2('top-controls'), RadioButtons, handleSelect, buttons, KeyboardLayout, layout === 'win' ? winKeyboardLayout : macKeyboardLayout, b$2('bottom-controls'), Button, handleReset, i18n('Reset'));
    }
    var templateObject_1$4;

    var b$1 = block('row');
    function Row(props) {
        return m$1(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"], ["<div class=\"", "\">\n        <div class=\"", "\">", "</div>\n        <div class=\"", "\">", "</div>\n    </div>"])), b$1(), b$1('category'), props.name, b$1('body'), props.children);
    }
    ...
    function List(props) {
        ...
        return filteredItems.length ? m$1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"], ["<", " name=\"", "\">\n        <ul class=\"", "\">\n        ", "\n        </ul>\n    <//>"])), Row, props.title, b(), filteredItems.map(function (item) {
            var name = item[0], value = item[1];
            if (item.length === 1) {
                return m$1(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["<li>", "</li>"], ["<li>", "</li>"])), name);
            }
    ...
    function KeyboardPage() {
        var items = [
            [m$1(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["<", " href=\"./keycodes.html\">", "<//>"], ["<", " href=\"./keycodes.html\">", "<//>"])), Link, i18n('Displaying key codes'))]
        ];
        return m$1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        <", ">\n            <", ">\n                ", "\n            <//>\n\n            <", " //>\n\n            <", " items=\"", "\" title=\"", "\" //>\n        <//>"], ["\n        <", ">\n            <", ">\n                ", "\n            <//>\n\n            <", " //>\n\n            <", " items=\"", "\" title=\"", "\" //>\n        <//>"])), Page, Header, i18n('Testing keyboard'), Keyboard, List, items, i18n('Additionally'));
    }
